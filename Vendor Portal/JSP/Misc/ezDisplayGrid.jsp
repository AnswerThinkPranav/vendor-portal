...
<Tr>
	...
	<Td style="background-color:'#F3F3F3'" valign=middle>
		<Table border="0" align="center" valign=middle width="100%">
			<Tr><Td style="background-color:'#F3F3F3'" height="300px">
				<Div id="gridbox" height="300px" width="100%" style="overflow:hidden;visibility:hidden;top:0%;background-color:'#F3F3F3'"></Div>
				<Div id="dataRetrieve" 	width="100%" height="300px"  style="position:absolute;background:#F3F3F3;overflow:hidden;top:30%;visibility:visible;">
					<Table align=center border="0" cellpadding="0" cellspacing="0" width="100%" style="background:#F3F3F3">
						<Tr>
							<Td align='center' style="background:#F3F3F3"><br><b>Loading data, please wait...</b><br><br><img src="../../../../EzCommon/Images/Grid/loading.gif"/></Td>
						</Tr>
					</Table>
				</Div>   
				<Div id="NoData" width="100%" height="300px"  style="position:absolute;background:#F3F3F3;overflow:hidden;top:30%;visibility:hidden;">
					<Table align=center border="0" cellpadding="0" cellspacing="0" width="100%" style="background:#F3F3F3">
						<Tr>
							<Td align='center' style="background:#F3F3F3"><br><b><font size=2><%=noDataStatement%></font></b></Td>
						</Tr>
					</Table>
				</Div>
				<Div id="ServerBusy" width="100%" height="300px"  style="position:absolute;background:#F3F3F3;overflow:hidden;top:10%;visibility:hidden;">
					<Table align=center border="0" cellpadding="0" cellspacing="0" width="100%" style="background:#F3F3F3">
						<Tr>
							<Td align='center' style="background:#F3F3F3"><img border=0 src="../../Images/sbusy.gif" ></Td>
							<Td align='center' style="background:#F3F3F3"><font color="00355D"><b>System Error.<BR> Please try again but if the error message reappears then contact us.</b></font></Td>
						</Tr>
					</Table>
				</Div> 				
			</Td></Tr>
