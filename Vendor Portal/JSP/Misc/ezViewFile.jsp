<%@ page import="java.io.*"%>
<%
	//String fileReqName 	= "E:\\Oracle\\Middleware\\user_projects\\domains\\base_domain\\applications\\MTR\\EzcView\\"+request.getParameter("filename");
	
	String serverFileName = request.getParameter("filename");
	
	if(serverFileName!=null)
		serverFileName = serverFileName.replace('*','\\');
	
	String fileReqName 	= serverFileName;	
