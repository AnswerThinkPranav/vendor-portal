...
%>
			<tr>
				<td align="left" width="95%"><input type="hidden" name="fileItemH" value="<%=retUploadList.getFieldValueString(r,"EUD_FILE_NAME")%>"><a href="javascript:downloadFile('<%=retUploadList.getFieldValueString(r,"EUD_ITEM_NO")%>','<%=retUploadList.getFieldValueString(r,"EUD_FILE_NAME")%>')"><%=retUploadList.getFieldValueString(r,"EUD_FILE_NAME")%></a></td>
...
%>
	...
	function funSelCountry()
	{
				...
				if (xmlhttp.readyState==4 && xmlhttp.status==200)
				{
					...
					if(xmlhttp.responseText!=null)
					{
						if(eval('document.myForm.country').value!="")
						{
						 ...
						 $('.select2').select2();
						 setSelectBoxVal('state','<%=State%>',false);
			...
			xmlhttp.open("get","ezGetRegionDtls.jsp?cnKey="+document.myForm.country.value+"&selVal='<%=State%>'",false); 
			xmlhttp.send();	
	}	
