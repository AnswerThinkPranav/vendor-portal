...
<%
	...
	if(vendCode != null)
	{
		...
		{
			vendCode = replaceString(vendCode,"*","%");
		}
		else
			vendCode = "%"+vendCode+"%";
	}
...
<Tr height=300px>
	...
	<Td style="background-color:'F3F3F3'" valign=middle>
		<Div id="Theads">
			<Table id="tabHead" width='100%' align=center  border=1 borderColorDark=#ffffff borderColorLight=#000000 cellPadding=5 cellSpacing=0>
				<Tr>
					<Th width=7%>&nbsp;&nbsp;</Th>
					<Th width=33%>Code</Th>
					<Th width=60%>Name</Th>
		...
		<Table  id="InnerBox1Tab" align=center  width=100% border=1 borderColorDark=#ffffff borderColorLight=#000000 cellPadding=5 cellSpacing=0>
<%
