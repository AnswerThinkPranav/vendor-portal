...
<%
		...
		{
%>
			<!--<table  class="table table-striped table-bordered dt-responsive nowrap" width="100%" border=1>
			<Tr>
				<td width="70%">&nbsp;</th>
				<th <%=trBGColor%> width="15%">Opening Balance</th>
				<td width="15%" align=right><%=invBal%></td>
			</Tr>
			</table>-->
			...
			<Tr>
				...
				<th <%=trBGColor%> width="15%" colspan="5">Opening Balance</th>
				<th width="15%" align=right><%=invBal%></th>
			</Tr>
			<Tr <%=trBGColor%> >
				<!--<th width="8%" rowspan="2">Clearing Doc No.</th>-->
				<th width="15%" rowspan="2"><%=transDate_L%></th>
				<th width="15%" rowspan="2"><%=particulars_L%></th>
				<th width="15%" rowspan="2">Bill Reference </th>
				<!--<th width="15%" rowspan="2">Cheque No/ DD No/RTGS</th>-->
				<th width="35%" colspan="2"><%=transAmount_L%></th>
				<th width="20%" rowspan="2"><%=bal_L%></th>
			</Tr>
			<Tr <%=trBGColor%>>
