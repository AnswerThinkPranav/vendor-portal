...
%>
			<li class="treeview"> 
				<a id="rfqMenu" href="#"><i class="fa fa-newspaper-o"></i> <span>Budget Price</span> <i class="fa fa-angle-left pull-right"></i></a> 
				<ul class="treeview-menu">
...
%>
				<a  id="qcfmenu" href="../RFQ/ezQCSList.jsp?type=ALL"><i class="fa fa-newspaper-o"></i> <span>QCFs</span></a> 	
				<a  id="pomenu" href="../RFQ/ezQCFPOList.jsp"><i class="fa fa-newspaper-o"></i> <span>Purchase Order</span></a> 	
...
%>	
			...
			<a id="rfqMenu" href="#"><i class="fa fa-newspaper-o"></i> <span>Auction</span> <i class="fa fa-angle-left pull-right"></i></a> 
				<ul class="treeview-menu">
					...
					<li><a href="../Request/ezListActiveAuctions.jsp">Current Auctions</a></li>
					<li><a href="../Request/ezListAuctionRequests.jsp?type=Closed">Completed Auctions<%//=comp_auc_L%></a></li>
			...
			<li class="treeview"> 
				...
				<ul class="treeview-menu">
					<li><a  id="pomenu" href="../RFQ/ezRfqMisReport.jsp?selPlant=ALL"><%=munuIetmIcon%><span>RFQ Report</span></a></li>
					<li><a  id="pomenu" href="../RFQ/ezQCFPOList.jsp"><%=munuIetmIcon%><span>PR-PO Report</span></a></li>
					<li><a href="../RFQ/ezTatReport.jsp"><%=munuIetmIcon%><span>TAT Report</span></a></li>
					<li><a href="../Request/ezAuctionPOList.jsp"><%=munuIetmIcon%><span>Auction_PO Report</span></a></li>
					<li><a href="../RFQ/ezMatPrices.jsp"><%=munuIetmIcon%><span>PriceTrends</span></a></li>
<%	
			if("VIW".equals(userRole))
			{
%>					
					<li><a href="../Misc/ezVendRegReport.jsp?type=Apr&venType=IN"><%=munuIetmIcon%><span>Vendor Registration Report</span></a></li>
<%
			}else{
%>
