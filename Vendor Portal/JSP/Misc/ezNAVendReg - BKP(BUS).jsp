...
<%
					...
					while(i.hasNext()) 
					{
						...
						ezc.ezcommon.EzLog4j.log("cntVal>>>>>>bus>>"+cntVal,"I");
						if("DTA".equals(busStatus)) 
						{
							chksel="checked";
							dispOtherBus="none";
						}	
						else if("EOU".equals(busStatus)){
							chksel="checked";
							dispOtherBus="none";
						}
						else if("SEZ".equals(busStatus)){
							chksel="checked";
							dispOtherBus="none";
						}
						else if("OTH".equals(busStatus)){
							chksel="checked";
							dispOtherBus="";
						}
...
%>					  
		...
		<Tr id="otherBus" style="display:<%=dispOtherBus%>;">
					<Th align="left">Businees Status Details<font color="red">*</font></Th>
					<Td colspan="3">
						<input type="text" class="form-control"  name="otherBusInfo" id="otherBusInfo" value="<%=checkNull(otherBusInfo)%>" maxlength="20" >
					</Td>					
				</Tr>
		<Tr>
...
<%
	if("LB".equals(userRole) || showApprove)
	{
		//isEditable = true;
%>
				<Tr>
...
<%
	...
	if("LB".equals(userRole) && showSubmit)
	{
%>
