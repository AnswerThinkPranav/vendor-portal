...
<%
	String siteAdd	    	= "www.vikreta2drl.com";
	String compNameDesc 	= "Dr.Reddy's";
%>
<html>
<head>
<style>
...
function news()
{
	window.showModalDialog("../News/ezVndrMsg.jsp","News","dialogheight=400px,dialogwidth=125px,toolbar=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no ,modal=yes");
}
</script>
<script src="../../Library/JavaScript/ezStatus.js"></script>
</head>

<body  onLoad="showBanner();news()">
<Div style='position:absolute;width:100%;top:0%;left:0%'>
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0 >
<TR>
	<TD style='background:white'>
		<IMG src="../../../../EzCommon/Images/Banner/drreddys_logo.gif">
	</TD>
</TR>
</TABLE>
</Div>
...
20. Limitation of liability
     ...
     contents, or these disclaimers and notices, contact the webmaster at www.thehackettgroup.com
