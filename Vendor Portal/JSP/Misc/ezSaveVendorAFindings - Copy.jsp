...
<%
	...
	String msgSubject = "Reply to the Audit Finding by Vendor : "+(String)session.getValue("Vendor");
	String ccMailIds  = "";
	String msgText = eMailData;
%>
<%//@include file="../Misc/ezSendMail.jsp"%> 
<%
	response.sendRedirect("../Shipment/ezMessage.jsp?Msg=Audit Status is updated.");
%>