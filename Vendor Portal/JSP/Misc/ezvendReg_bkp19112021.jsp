...
%>					  
				...
				<Tr>
					<Th align="left">E-Invoicing(Applicable if annual turnover in previous year is in excess of Rs.500 Cr. )</Th>
					<Td colspan="3">
						<div class="form-check">
<%
...
%>					
						<div class="form-check">
							<input class="form-check-input" type="radio"   name="vend_Site" value="Y" onChange="showField(this)" <%=chkSiteYes%>>&nbsp;&nbsp;&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input class="form-check-input" type="radio"   name="vend_Site" value="N" onChange="showField(this)" <%=chkSiteNo%>>&nbsp;&nbsp;&nbsp;No&nbsp;
						</div>
					</Td>
				</Tr>	
...
<%
					...
					{
%>					
						<input type="text" class="form-control validate[required]"   name="rtgs_Code" id="rtgs_Code" style="background-color:#ff0000bf" value="<%=checkNull(RTGSCode)%>" maxlength="100">
<%
					}else{
%>
...
<%
	...
	if(vendSubmit || showSubmit || showApprove)
	{
%>
...
<%
	...
	{
%>
				<button type="button" class="btn btn-success" onclick="funSubmit('V')" style="margin-right: 5px;"><i class="fa fa-submit"></i>&nbsp;Submit</button>
<%
	}
	if(showSubmit)
	{
...
<%
	...
	//if("VAR".equals(userRole) && "APPROVED".equals(wfStatus))
	if(showApprove)
	{
%>
