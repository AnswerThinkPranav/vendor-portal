...
<Div class="row">
	<Div class=" col-md-12 col-sm-12 col-xs-12"> 
		<Div class="box box-info collapsed-box">
			...
			<Div class="box-body" style="display: block;">
				...
				<Tr>
					...
					<Th align=right style="padding-top: 10px;line-height: inherit;">Vendor Name</Th>
					<Td colspan="4">
						<Input  type="text"   name="venName" id="venName" value="<%=venName%>"  maxlength="35" disabled style="width: 300px">
				...
				<Td colspan="4">
					...
					<Th align=right style="padding-top: 10px;line-height: inherit;">Service Based</Th>
					<Td colspan="4">
						<Input  type="radio"   name="serBased" id="serBased" value="Y"  maxlength="1" <%=("X".equals(serBased)) ? "CHECKED" : ""%> disabled>&nbsp;Yes &nbsp;&nbsp;&nbsp;
						<Input  type="radio"   name="serBased" id="serBased" value="N"  maxlength="1" <%=("".equals(serBased)) ? "CHECKED" : ""%> disabled>&nbsp;No
						
						<Input  type="hidden"   name="serBased_old" id="serBased_old" value="<%=("".equals(serBased)) ? "N" : "Y"%>" >
					</Td>
					<Th align=right style="padding-top: 10px;line-height: inherit;">GR Based</Th>
					<Td colspan="4">
						<Input  type="radio"   name="grBased" id="grBased" value="Y"  maxlength="1" <%=("X".equals(grBased)) ? "CHECKED" : ""%>disabled>&nbsp;Yes &nbsp;&nbsp;&nbsp;
						<Input  type="radio"   name="grBased" id="grBased" value="N"  maxlength="1" <%=("".equals(grBased)) ? "CHECKED" : ""%>disabled>&nbsp;No
		...
		<Div class="box box-info collapsed-box">
			...
			<TBody>
				...
				<Tr>
					...
					<Td colspan="4">
						<Input  type="text" style="text-transform: uppercase;"  name="addr1" id="addr1" value="<%=addr1%>"  maxlength="35">
					...
					<Td colspan="4">
						<Input  type="text" style="text-transform: uppercase;"  name="addr2" id="addr2" value="<%=addr2%>"  maxlength="35">
				...
				<Tr>
					...
					<Td colspan="4" style="padding-top: 15px;">India
				...
				<Tr>
					...
					<Td colspan="4">
						...
						<Input  type="text" style="text-transform: uppercase;"  name="district" id="district" value="<%=district%>"  maxlength="35">
				...
				<Th align=right style="padding-top: 10px;line-height: inherit;">
					...
					<Td colspan="4">
					<Input  type="text" style="text-transform: uppercase;"  name="contPers1" id="contPers1" value="<%=contPers1%>"  maxlength="35">
					...
					<Td colspan="4">
					<Input  type="text" style="text-transform: uppercase;"  name="contPers2" id="contPers2" value="<%=contPers2%>"  maxlength="35">
		...
		<Td colspan="4">
		<Input  type="text"  style="text-transform: uppercase;" name="pan" id="pan" value="<%=pan%>"  maxlength="10" >
		<Input  type="hidden" name="pan_old" id="pan_old" value="<%=pan%>" >
				...
				<Th align=right style="padding-top: 10px;line-height: inherit;">
					...
					<Td colspan="4">
					<Input  type="text" style="text-transform: uppercase;"  name="gst" id="gst" value="<%=gst%>"  maxlength="15" onchange="funGst()">
				...
				%>	
					...
					<Td colspan="4" >
					<select  name="classification" id="classification" style="width: 172px;">							
		...
		<Tr>
				...
				<select  name="minIndi" id="minIndi" style="width: 172px;">
				...
				<Th align=right style="padding-top: 15px;line-height: inherit;">
					Certification Date
					</Th>
				<Td colspan="4">
					<!--<Input  type="text"   name="cDate" id="cDate" value="<%=creatDate%>"  maxlength="10">&nbsp;<%=getDateImage("cDate")%>-->
					<input type="text" value=""  name="cDate" id="cDate"  >
					<span><label for="cDate" class="input-group-addon btn"> <img src='../../../../EzCommon/JavaScript/Calendar/Themes/icons/calendar7.gif' style='cursor:hand' id='butt"+field+"' border='none' valign='center'></label><br> <br><Font color=#ff0000 size=1><B>* In case of micro, small and medium enterprises.</B></Font></span> 
...
<input type="hidden" name="bankIndex" value="<%=bankIndexStr%>">
			...
			<Input  type="text" style="text-transform: uppercase;"  name="bankName" id="bankName" value="<%=bankName[k]%>"  maxlength="60">
			...
			<Td colspan="4">
			<Input  type="text" style="text-transform: uppercase;"  name="bankStreet" id="bankStreet" value="<%=bankStreet[k]%>"  maxlength="35">
			...
			<Td colspan="4">
			<Input  type="text" style="text-transform: uppercase;"  name="bankCity" id="bankCity" value="<%=bankCity[k]%>"  maxlength="35">
			...
			<Td colspan="4">
			<Input  type="text" style="text-transform: uppercase;"  name="bankBranch" id="bankBranch" value="<%=bankBranch[k]%>"  maxlength="40">
			...
			<Td colspan="4">
			<Input  type="text" style="text-transform: uppercase;"  name="bankIFSCCode" id="bankIFSCCode" value="<%=bankIFSCCode[k]%>"  maxlength="11">
...
<Div class="box box-info collapsed-box">            
			...
			<Td colspan="4" style="padding-top: 15px;">
			<input type="hidden" name="bankKey" value="<%=vendCode+(Integer.parseInt(bankIndexStr)+1)+""%>">
			India
			...
			<Td class="controls" colspan="4">
			<Input  type="text" style="text-transform: uppercase;"  name="bankName" id="bankName" value=""  maxlength="60">
			...
			<Td colspan="4">
			<Input  type="text" style="text-transform: uppercase;"  name="bankStreet" id="bankStreet" value=""  maxlength="35">
			...
			<Td colspan="4">
			<Input  type="text" style="text-transform: uppercase;"  name="bankCity" id="bankCity" value=""  maxlength="35">
			...
			<Td colspan="4">
			<Input  type="text" style="text-transform: uppercase;"  name="bankBranch" id="bankBranch" value=""  maxlength="40">
			...
			<Td colspan="4">
			<Input  type="text" style="text-transform: uppercase;"  name="bankIFSCCode" id="bankIFSCCode" value=""  maxlength="11">
...
<Div class="col-xs-12 col-md-12 col-md-offset-5 col-xs-offset-6 " >
	...
	<button type="button" class="btn btn-primary" onclick="funUpload('<%=bankListStr%>')">Upload Docs</button> 
...
function funGst()
{
	...
	if(gstCode!=gststatecode)
		{
		 alert("GST number does not match with PAN");
