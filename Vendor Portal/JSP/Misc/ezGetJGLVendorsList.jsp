<%
	...
	lv_VenTableRow.setQuery("SELECT EU_ID,EUD_VALUE,EU_FIRST_NAME FROM EZC_USERS,EZC_USER_DEFAULTS WHERE EU_ID = EUD_USER_ID AND EU_TYPE IN('3','4') AND EUD_KEY='SOLDTOPARTY'"+lv_QryStr+" ORDER BY EU_FIRST_NAME");
	...
	if(gv_VendorsRetObj!=null)
	{
		...
		if(gv_VendorsRetObjCnt>0)
		{
			...
			vendorsSelBox += "<Option value='ALL'>--ALL--</Option>";
