		...
		<div class="info-box"> 
			<div class="inner">
				<div class="small-box bg-aqua">
					...
					<p>
						&nbsp;PO(s) Amendments Pending For Approval&nbsp;&nbsp;<br>&nbsp;
					</p>
					<div class="icon">
						<i class="fa  fa-newspaper-o" style="font-size: 70px;margin-top: 15px"></i>
					</div>                     
			...
			<div class="info-box"> 
				<div class="inner">
					<div class="small-box bg-aqua">
						...
						<a href="../Misc/ezVNRList.jsp?type=Apr&venType=IN" class="small-box-footer">			
							More info 
							<i class="fa fa-arrow-circle-right"></i>
						</a>   					 
					</div>
...
<%
	if("PNEGI".equals(Session.getUserId()) || "AKUMARI".equals(Session.getUserId()) || "AANITHA".equals(Session.getUserId()) || "DSINGH3".equals(Session.getUserId()))
	{
%>
		...
		<center><a href="../RFQ/ezPrStatus.jsp"><Font color='RED'><B>Click here to Check for PR Status</B></Font></a></center>
<%
	}
	if("NVSHARMA".equals(Session.getUserId()))
	{
%>
		<center><a href="../Misc/ezGetVendUserMail.jsp"><Font color='RED'><B>Click here to update Vendor E-Mail</B></Font></a></center>
<%
	}
	if("PNEGI".equals(Session.getUserId()))
	{
%>		
		<BR><center><a href="../Misc/ezListWebStats.jsp?type=ALL"><Font color='RED'><B>Click here to check Web Stats</B></Font></a></center>
<%
	}
%>		
      <!-- /.row -->
