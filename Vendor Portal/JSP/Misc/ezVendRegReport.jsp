...
<%@include file="../../../Includes/JSPs/Misc/iVendRegReport.jsp"%>               
<%//@ include file="../Misc/ezCommonMethods.jsp"%>   
<style>
...
%>                        
                        ...
                        <th>Changed On</th>
                       	...
                       	<th>Inco<br>Terms</th>
                       	<th>PAN<br>Number</th>
                       	<th>GSTIN<br>Number</th>
                       	<th>Type of<br>Vendor</th>
                       	<th>Type of<br>Supplier</th>
                       	<th>Status<br>Supplier</th>
                       	<th>Bank Account<br>Number</th>
...
%>			
			...
			<td align="center"><%=checkNull((String)regEmailHT.get(qcfNo))%></td>	
			<td align="center"><%=checkNull((String)regPmntHT.get(qcfNo))%></td>	
			<td align="center"><%=checkNull((String)regIncoHT.get(qcfNo))%></td>	
			<td align="center"><%=checkNull((String)regPanHT.get(qcfNo))%></td>	
			<td align="center"><%=checkNull((String)regGstHT.get(qcfNo))%></td>
			<td align="center"><%=checkNull((String)vendorTypeHM.get((String)regVenTypeHT.get(qcfNo)))%></td>
			<td align="center"><%=checkNull((String)supTypeHM.get((String)regSupTypeHT.get(qcfNo)))%></td>
			<td align="center"><%=checkNull((String)msmeTypeHM.get((String)regMsmeTypeHT.get(qcfNo)))%></td>
			<td align="center"><%=checkNull((String)regAcctHT.get(qcfNo))%></td>
<%
			String qryStatus="";
			String hyperText="";
