...
<%
	...
	String offlineLink = portalURL+"ezLogin.jsp";
	String spaceCon 	="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";	
	...
	String mailText="Dear Sir/Madam,<br> Below Request details submitted for your approval<br><br>";
	...
	{
		if("VAR".equals(userRole) && "S".equals(actionSts) || "LB".equals(userRole) || "SCA".equals(userRole) && "S".equals(actionSts) && isNABuyer )
		{
			String qry="";
		...
		if("S".equals(actionSts))
		{
			...
			{
				String linkId=saveLinkControllerData(Session,docId,"VNR",userRet.getFieldValueString(i,"EU_ID"),userRet.getFieldValueString(i,"EU_EMAIL"),mailText);
				sendMails(Session,userRet.getFieldValueString(i,"EU_EMAIL"),ccEmailStr,"hchowdary@answerthink.com",mailText.replace("JBTEID",linkId),mailSub);
