...
if(retVendItemsCnt > 0)
{
	...
	//***************COMMERCIAL INFO*********************
	 ...
	 INCO_Terms2=retVendItems.getFieldValueString(rowIndex,"ECFD_VALUE");
	  ...
	  rowIndex=retVendItems.getRowId("ECFD_FIELD","Tax_vat");
	 Tax_vat=retVendItems.getFieldValueString(rowIndex,"ECFD_VALUE");
	...
	rowIndex=retVendItems.getRowId("ECFD_FIELD","INTAttach");
	INTAttach=retVendItems.getFieldValueString(rowIndex,"ECFD_VALUE");
