...
<div id="woModalQry" class="modal " tabindex="-1" role="dialog">
   <div class="modal-dialog">
...
window.closeUploadModal = function(){
	...
	{
		//alert("Modal");
		var url="../Misc/ezAddQueryReply.jsp?qcf_mode="+qcf_mode+"&docType="+docType+"&qcf_code="+qcf_code+"&qcf_dest_user="+qcf_dest_user+"&qcf_comment_no="+qcf_comment_no+"&qcf_user="+encodeURIComponent(qcf_user)+"&query="+ encodeURIComponent(query) +"&qryDate=" + encodeURIComponent(qryDate); 
		$('iframe').attr("src",url);
		$('#woModalQry').modal("show"); 
	}
