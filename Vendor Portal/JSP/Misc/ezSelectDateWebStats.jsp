	...
	<Td style="background-color:'#F3F3F3'" valign=middle>
		...
		<Tr>
			...
			<Td style='background:##F3F3F3;font-size=11px;color:#00355D;font-weight:bold;' width='30%' valign=center>
				&nbsp;&nbsp;<%=from_L%>&nbsp;&nbsp;<input type=text class=inputbox value="<%=fromDate%>" name="FromDate" id="FromDate"   readonly size=15 maxlength="10">&nbsp;<%=getDateImage("FromDate")%>
			</Td>
			<Td style='background:##F3F3F3;font-size=11px;color:#00355D;font-weight:bold;' width='24%' valign=center>
				<%=to_L%>&nbsp;&nbsp;<input type=text class=inputbox name="ToDate"  id="ToDate" value="<%=toDate%>"  readonly size=15 maxlength="10">&nbsp;<%=getDateImage("ToDate")%>
			</Td>
