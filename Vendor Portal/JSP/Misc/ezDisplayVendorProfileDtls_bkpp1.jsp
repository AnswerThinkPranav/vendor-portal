		...
		<TBody>
			<Tr>				
				...
				<Td colspan="4">
					...
					<Input readonly  type="hidden" style="text-transform: uppercase;" name="classification" id="classification" value="<%=EVEDCLASSI%>"  maxlength="2"><%=EVEDCLASSIDESC%>
				</Td>
			</Tr>			
			<Tr>
				<Th>Category</Th>
...
<Div class="col-xs-12 col-md-8 col-md-offset-4" >
	...
	<!--<button type="button" class="btn btn-primary" onclick="funUploadNew()">Upload File</button>-->
...
function funUploadNew()
{
		
		var Url="../Shipment/ezAttachFileNew.jsp";
			$.fancybox.open({
			href : Url,
			type : 'iframe',
			padding : 5,
