...
<jsp:useBean id="Session2" class="ezc.session.EzSession" scope="session"></jsp:useBean>
...
<%
	...
	String userIdNew = (String)Session2.getUserId();
	//out.println("userIdNew=="+userIdNew);
...
function ezAutoLogout()
{
	...
	var url="";
		url="http://"+location.host+"/JUBL/EzCommerce/EzVendor/Vendor2/JSPs/Misc/ezAutoLogout.jsp?noCache='"+(( new Date()).valueOf())+ "'&counter="+counter;
...
{
	var checkDuration = '30'
	if(counter > 1)
		checkDuration = checkDuration-1
	//alert("checkDuration::"+checkDuration);
...
<form name="footer" method="post" action="../Misc/mainMenuframeset.jsp" target="_parent">
<input type="hidden" name="footer" value="Y">
<input type="hidden" name="userIdNew" value="<%=userIdNew%>">
<input type="hidden" name="flag" value="X">
</form>
</body>
</html>
