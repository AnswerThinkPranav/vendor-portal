...
%>
		   ...
		   <table class="table table-bordered">
			<Tr>
				<Th align="left" width="30%">International Form(W8Form) <%if("IN".equals(vendType) && !"IN".equals(country)){%><%}%></Th>
				<Td width="20%">
...
<%
								...
								for (Map.Entry<String, String> entry : recAcctHM.entrySet()) 
								{
								            String reckey = entry.getKey();
								            String recvalue = entry.getValue();
								 	if(!compCode.equals(reckey))continue;
								            String[] valueParts = recvalue.split(",");
								            ...
								            for (String part : valueParts) 
								            {
            								   ...
            								   chksel="";
										if(recAccNum.equals(reconAccount))chksel="selected";
%>
									 <option value="<%=recAccNum%>" <%=chksel%> ><%=recAccNum%>--><%=recAccDesc%></option>
<%
