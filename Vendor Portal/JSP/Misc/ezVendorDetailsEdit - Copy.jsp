		...
		<Div class="box box-info collapsed-box">
			...
			<Div class="box-body" style="display: block;">
				...
				<Tr>
					...
					<Td colspan="4">Yes
						<Input  type="checkbox" style="text-transform: uppercase;" name="grBased" id="grBased" value="Y"  maxlength="1">
						
					</Td>
					<Td colspan="4">No
						<Input  type="checkbox" style="text-transform: uppercase;" name="grBased" id="grBased" value="N"  maxlength="1">
