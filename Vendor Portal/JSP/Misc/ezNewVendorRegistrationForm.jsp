...
<Div class="row">
	<Div class=" col-md-12 col-sm-12 col-xs-12"> 	
		...
		<Div class="box box-info collapsed-box">
			...
			<TBody>
				<Tr>
					...
					<Td colspan="4">
						<Input  type="text" style="text-transform: uppercase;"  name="name1" id="name1" value="<%=retQuery.getFieldValueString(0,"EVGD_NAME1")%>"  maxlength="35"  >
						
					</Td>
					<Th>Name2<font size="2" color="red"></font></Th>
					<Td colspan="4">
						<Input  type="text"  style="text-transform: uppercase;" name="name2" id="name2" value=""  maxlength="35"  >
				...
				<Tr>
					...
					<Td colspan="4">
						<Input  type="text" style="text-transform: uppercase;"  name="addr1" id="addr1" value=""  maxlength="35">
						
					</Td>

					<Th>Addr2<font size="2" color="red"></font></Th>
					<Td colspan="4">
						<Input  type="text" style="text-transform: uppercase;"   name="addr2" id="addr2" value=""  maxlength="35">
						
					</Td>
					<Th>Street<font size="2" color="red"></font></Th>
					<Td colspan="4">
						<Input  type="text" style="text-transform: uppercase;"  name="street" id="street" value=""  maxlength="60">
				...
				<Tr>
					...
					<Td colspan="4">
						<Input  type="text" style="text-transform: uppercase;"  name="city" id="city" value="<%=retQuery.getFieldValueString(0,"EVGD_CITY")%>"  maxlength="35">
				...
				<Tr>
					...
					<Td colspan="4">
						...
						<Input  type="text" style="text-transform: uppercase;"  name="district" id="district" value=""  maxlength="35">
					</Td>
					...
					<Td colspan="4">
						<Input  type="text"   name="mobile" id="mobile" value="<%=retQuery.getFieldValueString(0,"EVGD_MOBILE")%>"  maxlength="16">
				...
				<Tr>
					...
					<Td colspan="4">
						<Input  type="text"   name="email" id="email" value="<%=retQuery.getFieldValueString(0,"EVGD_EMAIL")%>"  maxlength="241">
					</Td>
				...
				<Th>
					...
					<Td colspan="4">
					<Input  type="text" style="text-transform: uppercase;"  name="contPers1" id="contPers1" value=""  maxlength="35">
					</Td>
					<Th>
						Contact Person 2<font size="2" color="red"></font>
					</Th>
					<Td colspan="4">
					<Input  type="text" style="text-transform: uppercase;"  name="contPers2" id="contPers2" value=""  maxlength="35">
		...
		<Td colspan="4">
		<Input  type="text" style="text-transform: uppercase;"  name="pan" id="pan" value=""  maxlength="10" >
		</Td>
		<Th>
					GSTIN<font size="2" color="red"></font>
					</Th>
					<Td colspan="4">
					<Input  type="text" style="text-transform: uppercase;"  name="gst" id="gst" value=""  maxlength="15" onchange="funGst()">
				</Td>
				<Th>
		...
		<Tr>
				...
				<Td colspan="4">
				<select style="width: 182px;" name="minIndi" id="minIndi" style="width: 172px;">
			...
			<Td colspan="4">
				...
				<img src='../../../../EzCommon/JavaScript/Calendar/Themes/icons/calendar7.gif' style='cursor:hand' id='butt"+field+"' border='none' valign='center'>
				<input type="text" label for="cDate" value=""  name="cDate" id="cDate"  ><BR>
		...
		<Input  type="text" style="text-transform: uppercase;"  name="bankName" id="bankName" value="" >
		</Td>
		<Th>
