...
<%
	...
	String companyCode 	= request.getParameter("selCompCode");
	...
	int noOfQ=Integer.parseInt(noOfQtrs);
	...
	if(fd != null && td != null)
	{
		...
		ioparams.setCompCode(companyCode);

		eviip.setInvoiceFlag("B");
		ioparams.setToDate(toDateObj);		//fromDateObj
		ioparams.setFromDate(fromDateObj);
		ioparams.setCompCode(request.getParameter("selCompCode"));//company code added for mtr
		...
		ioparams1.setCompCode(request.getParameter("selCompCode"));//company code added for mtr
...
%>
	...
	<%//@ include file="../Misc/ezSelectDateForQtr.jsp"%>
<%
...
%>
			...
			<Div id="ButtonDiv" style="position:absolute;top:50%;width:80%;visibility:visible">
			<Table>
			<Tr>
				<Th>Comments</Th>
				<td><textarea name='comments' rows='5' cols='140'></textarea></Td>
			</Tr>
			</Table>
			</Div>
...
%>
			...
			<div id="InnerBox1Div" STYLE='overflow:auto;Position:relative;width:96%;Left=2%;height:50%' align="center">
