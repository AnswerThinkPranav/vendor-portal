...
<%
   ...
   miscTableRow1.setQuery("INSERT INTO ezc_customer_form_header (ECFH_DOC_ID, ECFH_SALES_ORG,ECFH_EXT1, ECFH_EXT2,ECFH_STATUS,ECFH_CUST_NAME,ECFH_CREATED_BY,ECFH_CREATED_ON,ECFH_MODIFIED_BY,ECFH_MODIFIED_ON,ECFH_MASTER_TYPE,ECFH_PAN_NO,ECFH_VEN_GRP,ECFH_VEN_TYPE,ECFH_PLANT,ECFH_CATEGORY) VALUES('"+tempUserId+"','"+purOrg+"','"+compCode+"','"+dept+"','RFQ','"+userName+"','"+Session.getUserId()+"',now(),'"+Session.getUserId()+"',now(),'V','"+panNo+"','"+venGrp+"','"+venType+"','"+selPlant+"','"+selCategory+"')");
...
<%
	...
	if(!error)
	{
		...
		eMailData  = "Below are your temporary login credentials to respond for RFQ<Br>";
