...
<div style="position:absolute;top:16%;left:0%;width:100%;">
	<Table width="60%" align=center   borderColorDark=#ffffff borderColorLight=#000000 cellPadding=5 cellSpacing=0>
		<tr>
			<th align="center" width="12%" height='40px'>	Tool Holding Certificate	</th>			
			<th align="center" width="12%" height='40px'>8 D Certificate</th>
			<th align="center" width="12%" height='40px'>C - Form</th>
		</tr>
		<Tr>
		...
		<Tr>
			...
			<Td align="center" style='background-color:#c9e0ff'  height='40px'>
				<a href="Javascript:void(0)" name="uploadDC" onClick=validationsCF()><IMG src="../../Images/upload.png" width=100 height=25 border=none></a>
			</Td>
		</Tr>
		<Tr >
			<Td align="center"  height='40px'>
			...
			<Td align="center"  height='40px'>
				<a href="Javascript:void(0)" onClick="window.open('../Inbox/ezListUploadedCF.jsp','popuppage','left=510,top=180,width=400,height=360,statusbar=yes');"  onMouseout="window.status=' '; return true">
					<font size=2 color='#FF3300'><B>List of Uploaded Certificates </B></font>
				</a>	
			</Td>			
		</Tr>
