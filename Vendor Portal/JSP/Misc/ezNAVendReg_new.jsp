...
%>
		   ...
		   <table class="table table-bordered">
						<Tr>
							<Th align="left" width="30%"><%=w8Form_L%><%if("IM".equals(vendType)){%><font color="red">*</font><%}%></Th>
							<Td width="20%">
...
%>
				...
				<Tr>
					<Th align="left"> Recon Account Type </Th>
					<Td>
...
%>
					...
					else
					{
						...
						else if(status == "P")
						{
							...
							{					
								...
								document.myForm.action="ezPostImpVendorToSAP_new.jsp";								
								document.myForm.submit();
							}
						}
						else if(status == "R")
	...
	function isValidFinInfo()
	{
		...
		if((vendSite == "Y" && siteViDt!="") && (vendSite == "Y" && sitePerson!="")  && (vendTrans == "Y" && vendDtls!="") && (vendJgl == "Y" && vendUnit!="" ) )
		{
			return true;
		}
		if(vendSite == "N" && vendTrans == "N" && vendJgl == "N" )
		{
			return true;
		}
	}
