...
String  ORT01Bank="",BKREF="";
	...
	out.println("docMaxstep:::::"+docMaxstep);
	out.println("docCurStep::::"+docCurStep);
...
JCoParameterList impParam = function.getImportParameterList();
	...
	if(!title.equals(ANRED.trim())|| !"".equals(title) || !"null".equals(title)){
	titleChanged=true;
...
String contPers1 = "";
		...
		String cont1Style="";
		try{
		contPers1 =checkNull(generalDataRetObj.getFieldValueString(0,"EVGD_EMAIL"));
		}catch(Exception e){}
...
String contPers2 = "";
		...
		String cont2Style="";
		try{
		contPers2 =checkNull(generalDataRetObj.getFieldValueString(0,"EVGD_EMAIL"));
		}catch(Exception e){}
...
<%			if(docMaxstep.equals(docCurStep))
			{
%>
				<button type="button" class="btn btn-primary" onclick="funSubmit('SUBMITTED')">Approve</button>
...
<%
			...
			{
%>
				<button type="button" class="btn btn-primary" onclick="funSubmit('APPROVED')">Submitted</button>
				<button type="button" class="btn btn-primary" onclick="funSubmit('REJECTED')">Reject</button>
	<%
			}
		}
