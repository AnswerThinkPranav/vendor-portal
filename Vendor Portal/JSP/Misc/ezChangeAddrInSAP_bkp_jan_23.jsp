...
<%
	...
	String msgSubject ="Vendor Address Change Request Approved[ "+Session.getUserId()+"]";
	String msgText = "";
	String sendToUser=vdr;
	msgText += "Dear Sir/Madam,<Br><br> Address Change Request is Approved.<br>";
