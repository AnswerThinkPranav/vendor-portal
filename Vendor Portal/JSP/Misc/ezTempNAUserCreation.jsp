...
<%
	//out.println("vendCreSucc_L>>>>>"+vendCreSucc_L);
	//out.println("dispHdrVendReg_L>>>>>"+dispHdrVendReg_L);
...
<%
	...
	String selCategory=checkNull(request.getParameter("selCategory"));
...
<%	
	String display_header = dispHdrVendReg_L; 
...
<Br>
	...
	<tr>	
			...
			<Td>
			 <select class="form-control select2" name="purOrg" id="purOrg" style="width:100% !important">
			...
			<Td>
					<select class="form-control select2" name="compCode" id="compCode" style="width:100% !important">
...
%>
		...
		<tr>
			...
			<Td colspan='3'>
				<textarea name = 'reason' id='reason' style='width:100%' rows=3 cols=73 ></textarea>
			</td>		
		</tr> -->
</table>
...
<script>
	...
	function funSave()
	{
		...
		var z = 'Y';
		let compCode=document.myForm.compCode.value;
		let purOrg=document.myForm.purOrg.value;
	...
	function onPlantChg()
	{
		...
		if(plant == 9001)
		{
			$("#purOrg").val("9000").trigger('change');
			$("#purOrg").prop("disabled",true).trigger('change');
			$("#compCode").val("9000").trigger('change');
