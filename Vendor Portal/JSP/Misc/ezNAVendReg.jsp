				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<tr>
							    ...
							    <th align="left"><%=zip_Code_L%><font color="red">*</font></th>
							    <td>
...
%>
						...
						<tr>
							   <th align="left"><%=Addr_Line5_L%></th>
							    ...
							    <th align="left"><%=Region_L%> <font color="red">*</font></th>
							    <Td id="REGION">
					...
					<div class="box-body">
						<table id="contactTab" class="table table-bordered">
							<tr>
								    ...
								    <Th align="left"><%=Title_L%></Th> 
								    <th align="left"><%=main_cont_per_L%></th>
								    <th align="left"><%=designation_L%></th>
								    <th align="left"><%=phone_no_L%></th>
								    <th align="left"><%=email_L%></th>
...
%>					
				...
				<tr>
								<Th align="left"> <%=pmnt_Terms_L%> <font color="red">*</font></Th>
								<Td>
									<input type="text" class="form-control validate[required]"  id="paymntTermsText" name="paymntTermsText"  value="<%=checkNull(paymntTermsText)%>" maxlength="100"  data-errormessage-value-missing="Please Enter Payment Terms">
								</Td>
				</tr>
			</table>
				</td>
			...
			<table class="table table-bordered" style="display:none"  id="isCountryIndia">
				<Tr style="width:31%;">
					<Th align="left" style="width:34%;"><%=copy_of_pan_L%></Th>
					<Td>
...
%>							
				...
				<Tr>
					<Th align="left" width="61%"><%=JUBL_entities_L%></Th>
					<Td colspan="3">
						<div class="form-check">
<%
...
%>						
				...
				<Tr>
					<Th align="left" width="61%"><%=vend_Trans_L%></Th>
					<Td colspan="3">
						<div class="form-check">
<%
...
%>						
				...
				<Tr id="vendDtls" style="display:<%=dispDtls%>;">
					<Th align="left"><5=vend_Details_L%><font color="red">*</font></Th>
					<Td colspan="3" >
						<input type="text" class="form-control"  name="vend_Dtls"  value="<%=checkNull(vend_Dtls)%>" maxlength="100" >
					</Td>					
				</Tr>				
				<Tr>
					<Th align="left" width="61%"><%=site_Visit_L%></Th>
					<Td colspan="3">
<%
...
%>					
				...
				<Tr id="sitePerson" style="display:<%=dispSite%>;">
					<Th align="left"><%=per_Name_L%> <font color="red">*</font> </Th>
					<Td colspan="3">
				...
				<Tr id="siteViDt" style="display:<%=dispSite%>;">
					<Th align="left"><%=site_Visit_On_L%><font color="red">*</font> </Th>
					<Td colspan="3">
...
%>
		  	<table class="table table-bordered">
				<Tr>
					...
					<td width="20%"><button type="button"  value = "VENDSOP"  class="btn btn-primary uploadDialogBtn" ><i class="fa fa-upload"></i>&nbsp;<%=Upload_L%></button></td>
					<td width="30%">
...
%>
		  <!--My attchment task-->
		   <table class="table table-bordered">
				<Tr>
					<Th align="left" width="30%"><%=w9Form_L%> <%if("IN".equals(vendType) && !"IN".equals(country)){%><%}%></Th>
					<Td width="20%">
...
%>
			<table class="table table-bordered">
			<Tr>
				<Th align="left" width="30%"><%=w9Form_L%> <%if("IN".equals(vendType) && !"IN".equals(country)){%><font color="red">*</font><%}%></Th>
				<Td width="20%">
					<input type="text" class="form-control "  name="w9Attach" id="w9Attach" value="<%=checkNull(w9Attach)%>" maxlength="20" >
				</Td>
				<td width="20%"><button type="button"  value = "VENDW9"  class="btn btn-primary uploadDialogBtn" ><i class="fa fa-upload"></i>&nbsp;<%=Upload_L%></button></td>
...
%>
		   ...
		   <table class="table table-bordered">
			<Tr>
				<Th align="left" width="30%"><%=w8Form_L%><%if("IN".equals(vendType) && !"IN".equals(country)){%><%}%></Th>
				<Td width="20%">
...
%>	    	
		  ...
		  <input type="hidden" name="tabVal5" id="tabVal5" value="5" >
		  	...
		  	<table class="table table-bordered">
		  	<Tr>	
				<Th align="left">Type of payment <font color="red">*</font> </Th>
				<Td colspan="2">
				<div class="form-check">
<%
					String dispPmntMode="";
					set = pmntModeHM.entrySet(); 
					i = set.iterator();
					while(i.hasNext()) 
					{
						Map.Entry me_pmnt = (Map.Entry)i.next();
						cntVal=(String)me_pmnt.getKey();
						chksel="";
						if("".equals(Pmnt_Mode) && "ACH".equals(cntVal))
						{
							chksel="checked";
						}
						//me.getValue()
						if(cntVal.equals(Pmnt_Mode))chksel="checked";

%>
							<input type="radio" name="pmntMode"  class="form-check-input validate[required]" data-errormessage-value-missing="Please Select type of Payment" value="<%=me_pmnt.getKey()%>" <%=chksel%> onChange="showPmntMode(this)">&nbsp;&nbsp;&nbsp;<%=me_pmnt.getValue()%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<%
					}
%>
			</Tr>
			...
			<Tr id="bankDtls1">
					...
					<Td>
						<input type="text" class="form-control validate[required]"  name="accnt_Per" id="accnt_Per" value="<%=checkNull(Accnt_Person)%>" data-errormessage-value-missing="Please enter Accounting Point person name" maxlength="100">
					</Td>
					<Th align="left"><%=vendEmail_L%> <font color="red">*</font> </Th>
					<Td>
					<input type="text" class="form-control validate[required]" data-errormessage-value-missing="Please enter Vendor Email"  name="accnt_Email" id="accnt_Email" value="<%=checkNull(Accnt_Email)%>" maxlength="100">
					</Td>
				...
				<Tr id="bankDtls2">
					...
					<Td>
					<input type="text" class="form-control validate[required]" data-errormessage-value-missing="Please enter Mobile number"  name="accnt_Mobile" id="accnt_Mobile" value="<%=checkNull(Accnt_Mobile)%>" minlength="15" maxlength="15" onKeyPress="return onlyNumbers()" >
					</Td>				
...
%>
				...
				<Tr id="bankDtls3">
					...
					<Td>
						<input type="text" class="form-control validate[required]" data-errormessage-value-missing="Please enter Bank Name"  name="bankName" id="bankName" value="<%=checkNull(BankName)%>" maxlength="100">
					</Td>
					<Th align="left"><%=branch_L%> <font color="red">*</font> </Th>
					<Td>
						<input type="text" class="form-control validate[required]"  data-errormessage-value-missing="Please enter Branch Name" name="bank_Branch" id="bank_Branch" value="<%=checkNull(Branch)%>" maxlength="100">
					</Td>
				...
				<Tr id="bankDtls4">
					...
					<Td>
						<input type="text" class="form-control validate[required]" data-errormessage-value-missing="Please enter Account Number" name="accnt_Number" id="accnt_Number" value="<%=checkNull(Account_Number)%>"  maxlength="50" onKeyPress="return onlyNumbers()">
					</Td>
					<Th align="left"><%=swift_Code_L%><font color="red">*</font> </Th>
					<Td>
						<input type="text" class="form-control validate[required]"  data-errormessage-value-missing="Please enter Swift Code" name="bank_Swift" id="bank_Swift" value="<%=checkNull(BankSwift)%>" maxlength="100">
					</Td>
				</Tr>
				<Tr id="bankDtls5" >
					<Th align="left"><%=cancelled_Cheque_L%><font color="red">*</font> </Th>
					<Td>
						<input type="text" class="form-control validate[required]"   name="chequeNo" id="chequeNo" value="<%=checkNull(chequeNo)%>" maxlength="100">
					</Td>					
...
%>
				<Tr>
					<Th colspan="2" align="left">Account Group<font color="red">*</font> </Th>
					<Td colspan="2">
...
%>
					...
					<Th align="left"> <%=recon_Acc_L%> <font color="red">*</font> <font color="red">*</font></Th>
					<Td>
...
%>
		<Table align="center" width="100%" border=1 borderColorDark=#ffffff borderColorLight=#006666 cellPadding=2 cellSpacing=0 >
			<Tr <%=trBGColor%>>
				<Th align=left ><B><%=enter_Comments_L%></B></Th>
			</Tr>
			<Tr>	
...
<div id="woModal" class="modal " tabindex="-1" role="dialog">
   ...
   <div class="modal-dialog">
      ...
      <div class="modal-header">
		...
		<span aria-hidden="true">x</span></button>
	      <h4 class="modal-title"><%=attchmnt_L%></h4>
	</div>
	 <div class="modal-body">	     
	         <fieldset>  
	 ...
	 <button type="submit" id="uploadbutton" class="btn btn-primary"><%=Upload_L%></button>
	 </div>
      </div>
     </form>
   </div>  
</div>
<div id="uploadModTemp" class="modal " tabindex="-1" role="dialog">
   <div class="modal-dialog">
	 ...
	 <div class="modal-footer">
	 	<button type="submit" id="uploadbuttonTemp" class="btn btn-primary"><%=Upload_L%></button>
	 </div>
      </div>
     </form>
   </div>  
...
%>
				...
				else
				{
					...
					else
					{
						...
						else if(status == "U") 
						{
							...
							else if(!$("#myForm").validationEngine('validate'))
							{
								return ;
							}
							else
							{
								if(confirm("Are you sure you want to Re-submit?"))
								{
									$('#myForm').find('input, textarea, select').attr('disabled',false);
									document.myForm.actionSts.value=status;
									document.myForm.action="ezSubmitVendRegOthMat.jsp"; 
	...
	function showPmntMode(fieldObj)
	{
		var fieldVal = fieldObj.value;
		//alert("fieldVal>>>>>>"+fieldVal);
		if(fieldVal!="ACH")
		{
			document.getElementById("accnt_Per").disabled=false;
			document.getElementById("accnt_Email").disabled=false;
			document.getElementById("accnt_Mobile").disabled=false;
			document.getElementById("rtgs_Code").disabled=false;
			document.getElementById("bankName").disabled=false;
			document.getElementById("bank_Branch").disabled=false;
			document.getElementById("accnt_Number").disabled=false;
			document.getElementById("bank_Swift").disabled=false;
			document.getElementById("chequeNo").disabled=false;
			document.getElementById("VENDREGCHEQ").disabled=false;
		}
		else
		{
			document.getElementById("accnt_Per").value="";
			document.getElementById("accnt_Per").disabled=true;
			document.getElementById("accnt_Email").value="";
			document.getElementById("accnt_Email").disabled=true;
			document.getElementById("accnt_Mobile").value="";
			document.getElementById("accnt_Mobile").disabled=true;
			document.getElementById("rtgs_Code").value="";
			document.getElementById("rtgs_Code").disabled=true;
			document.getElementById("bankName").value="";
			document.getElementById("bankName").disabled=true;
			document.getElementById("bank_Branch").value="";
			document.getElementById("bank_Branch").disabled=true;
			document.getElementById("accnt_Number").value="";
			document.getElementById("accnt_Number").disabled=true;
			document.getElementById("bank_Swift").value="";
			document.getElementById("bank_Swift").disabled=true;
			document.getElementById("chequeNo").value="";
			document.getElementById("chequeNo").disabled=true;
			document.getElementById("VENDREGCHEQ").disabled=true;
	...
	function isValidAttachments()
	{
		...
		if(vendType=="IN")
		{
			//alert("::country:::::US-Vendor:::"+country);
	...
	function isValidBankInfo()
	{
		...
		//alert("chequeNo>>>>>>>>>"+chequeNo);
		var bankTabLen = $('#VENDREGCHEQTABLE tr').length;
		//alert("bankTabLen>>>>>>>>>"+bankTabLen);
