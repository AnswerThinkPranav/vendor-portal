...
<%
	...
	if("PNEGI".equals(userId))
	{
		ezc.ezcommon.EzLog4j.log("::::userId_KATT:::"+userId,"I");
%>		
	<div class="col-lg-4 col-xs-6"> 
		<div class="info-box"> 
			<div class="inner">
...
%>
		...
		<center><a href="../Misc/ezUsersList.jsp"><Font color='RED'><B>Click here to Send Login Credentials</B></Font></a></center>
<%
	}
%>
