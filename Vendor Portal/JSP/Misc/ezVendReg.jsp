...
<% ezc.ezcommon.EzLog4j.log("Start of the reg page","I");%>
...
<% ezc.ezcommon.EzLog4j.log("11Start of the reg page","I");%>
<%@ include file="ezCountryHT.jsp"%> 
<%@ include file="../../../Includes/JSPs/Misc/iDocComments.jsp"%> 
<% ezc.ezcommon.EzLog4j.log("afterdoccommetsStart of the reg page","I");%>
<%@ include file="../../../Includes/JSPs/Inbox/iGetUploadList.jsp"%>  
<% ezc.ezcommon.EzLog4j.log("afterupliadStart of the reg page","I");%>
<%@ include file="iViewVendRegDetails.jsp"%> 
<% ezc.ezcommon.EzLog4j.log("afterdetailsStart of the reg page","I");%>
<%@ include file="iViewVendRegHeader.jsp"%>  
<% ezc.ezcommon.EzLog4j.log("afterheaderStart of the reg page","I");%>
...
<%
	...
	if(retQry != null)
		...
		ezc.ezcommon.EzLog4j.log(" 53Start of the reg page","I");
%>
...
<%
									...
									while(i.hasNext()) 
									{
										...
										chksel="";
										ezc.ezcommon.EzLog4j.log(" 803Start of the reg page","I");
						...
						<tr>
							   <th align="left">Address Line 5</th>
								...
								<Select name="state" id="state" class="form-control input-sm validate[required]" data-errormessage-value-missing="Please Enter state" name="state" >
									...
									<option value="HS">Hertfordshire</option>
...
<%
									...
									ezc.ezcommon.EzLog4j.log(" 933Start of the reg page","I");
%>	
...
%>									
					...
					<Td colspan="3">
						<div>
<%						
ezc.ezcommon.EzLog4j.log(" 1075Start of the reg page","I");
...
%>						
				...
				<Tr>
					<Th align="left">Is Supplier done any transaction earlier with Jubilant with any other name or related concerns firm</Th>
					<Td colspan="3">
						<div class="form-check">
<%
		  ...
		  <input type="hidden" name="tabVal5" id="tabVal5" value="5" >
			...
			<Tr>
				...
				<Tr>
					...
					<Td>
<%
					if("Y".equals(showStr) && "VAR".equals(userRole) && !"715281".equals(docId))
					{
%>					
...
<%
					}else if("715281".equals(docId)){
%>
						<input type="text" class="form-control"   name="rtgs_Code" id="rtgs_Code"  value="<%=checkNull(RTGSCode)%>" maxlength="100">				
<%
...
<div id="woModal" class="modal " tabindex="-1" role="dialog" style="opacity:1!important">
...
<div id="uploadMod" class="modal fade" tabindex="-1" role="dialog" style="opacity: 1!important"> 
   <div class="modal-dialog">
			...
			$.ajax({
				...
				else
				{
					...
					else
					{
						if(status == "V") 
						{
							if(!$("#myForm").validationEngine('validate') && chkVendor!="715281")
							{
								return ;
							}
							else if(!isValidBankInfo() && chkVendor!="715281")
		    					{
		    						return ;
		    					}
							else
						...
						else 
						{
							...
							var chkStr = '<%=showStr%>';
							//alert("chkStr>>>"+chkStr);
							if((chkStr == "Y") &&(role == "VAR") && chkVendor!="715281")
							{
