...
<%
	...
	{
%>
		<meta http-equiv="refresh" content="2;url=/JUBL/ezLogin.jsp">
<%
	}
%>
<title>JUBILANT GENERICS--LOGOUT</title>
...
%>
					...
					browser doesn't support the refresh tag click <b><a href="<%=request.getScheme()%>:"+"/JUBL/ezLogin.jsp">here</a></b>
...
<%
				...
				{
%>
					<font size="2" face="tahoma"><b>Maximum idle time exceeded...Logging out automatically<BR><BR>Click <a href="<%=request.getScheme()%>"+"/JUBL/ezLogin.jsp">here</a> to login again</b></font>
<%
				}
%>
