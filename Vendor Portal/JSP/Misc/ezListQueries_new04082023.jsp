...
<%
			...
			String docNo = "",docType="",vendorNo="",tmpDType="";
...
%>	 	
				...
				<Tr>
					...
					<td align="center">					
<%
				if(!naCompHt.contains(qcsRet1.getFieldValueString("ECFH_EXT1")))
				{
					if("IN".equals(qcsRet1.getFieldValueString("ECFH_VEN_TYPE"))){
%>
						<a style='text-decoration:underline' href="ezVendReg.jsp?docId=<%=qcsRet.getFieldValueString(i,"EQC_CODE")%>"><%=qcsRet.getFieldValueString(i,"EQC_CODE")%></a>
<%		
					}else if("IM".equals(qcsRet1.getFieldValueString("ECFH_VEN_TYPE"))){
%>
