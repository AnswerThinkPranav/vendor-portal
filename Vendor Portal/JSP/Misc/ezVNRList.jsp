			...
			for(int i=0;i<Count;i++)   
                        {
                        		...
                        		compCode= hdrXML.getFieldValueString(i,"ECFH_EXT1");
                        		...
                        		plant = hdrXML.getFieldValueString(i,"ECFH_PLANT");
...
<%
			...
			{			
				if("IN".equals(venType) && (("4410".equals(plant)) || ("4480".equals(plant)) || ("4470".equals(plant)))) 
				{ 
%>					
...
%>	
						<a style='text-decoration:underline' href="ezNAVendReg.jsp?docId=<%=hdrXML.getFieldValueString(i,"ECFH_DOC_ID")%>"><%=hdrXML.getFieldValueString(i,"ECFH_DOC_ID")%></a>
<%
				}
%>
			</td>
