...
%>
		...
		<tr>
			<th colspan='1' align="right"  <%=trBGColor%>><%=vendAuth_L%><font color="red">*</font></th>
...
%>
	...
	<center>
		...
		<button type="button"   class="btn btn-info uploadDialogBtnTemp" ><i class="fa fa-upload"></i>&nbsp;Upload Attachments</button>			
	</center>
...
<input type="hidden" name="selCategory" id="selCategory" value='RM_PM' >
</Form>
...
<script>
	...
	function funSave()
	{
		...
		if(rfqAuth == 'Y' || regAuth == 'Y' )
		{
			...
			document.myForm.action = "ezAddTempUser_new.jsp";
