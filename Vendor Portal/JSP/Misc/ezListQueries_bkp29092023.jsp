...
<%
				...
				boolean containsValue = true;//hashCompCode.containsValue(compCodeTest);
				ezc.ezcommon.EzLog4j.log("**compCodeTest>>>>"+compCodeTest,"I");
				ezc.ezcommon.EzLog4j.log("**containsValue>>>>"+containsValue,"I");
				if((containsValue) && hashCompCode.containsKey(docNo))
				{
					ezc.ezcommon.EzLog4j.log("** 1st IF>>>>"+1111,"I");
					if("IN".equals(qcsRet1.getFieldValueString(i,"ECFH_VEN_TYPE"))){
					ezc.ezcommon.EzLog4j.log("** 2nd IF>>>>"+2222,"I");
%>
						<a style='text-decoration:underline' href="ezVendReg.jsp?docId=<%=docNo%>"><%=docNo%></a>
<%		
					}else if("IM".equals(qcsRet1.getFieldValueString(i,"ECFH_VEN_TYPE"))){
