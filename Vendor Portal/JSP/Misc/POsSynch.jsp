...
<%
	...
	ezc.ezcommon.EzLog4j.log("CFLADM TIME STAMP>>>>ManualFromDate>>>>"+FromDate,"I");
	//ezc.ezcommon.EzLog4j.log("CFLADM TIME STAMP>>>>ManualToDate>>>>"+ToDate,"I");
	...
	try
	{
		...
		//sapPurOrd.setValue("ITEMS_OPEN_FOR_RECEIPT","O");
		sapPurOrd.setValue("CO_CODE","CFL");

		if (FromDate != null )
			sapPurOrd.setValue("DOC_DATE","2020-02-11");
			//sapPurOrd.setValue("DOC_DATE",FromDate);
			
		sapPurOrd.setValue("TO_DATE","2020-02-11");	
...
<%
						...
						String eMailData = "Dear Sir/Madam, <Br><Br>Below PO is released. <Br>"+smsPO+" <Br><Br>Please login to the vendor portal to acknowledge the PO.<Br><Br>Regards,<Br> Coromandel International Limited. <Br><Br><B>Portal Link : <a href='http://vendors.coromandel.biz'  target=_blank>http://vendors.coromandel.biz</a></B>";
