...
%>
			...
			<td><select name="category" id="category" style="width: 400px;">
				...
				<option value="Vendor statement of accounts">Vendor statement of accounts</option>
				<option value="Invoice status">Invoice status</option>
				<option value="Vendor Master Update">Vendor Master Update</option>
				<option value="Vendor code creation">Vendor code creation</option>
				<option value="Vendor code Block / Unblock">Vendor code Block / Unblock</option>
				<option value="Vendor method payment method update">Vendor method payment method update</option>
				<option value="C - FORM Status">C - FORM Status</option>
				<option value="HSN/SAC request">HSN/SAC request</option>
			 ...
			 <textarea class="form-control"style="width: 400px;" rows="5" placeholder="Enter Comments" name="comment" id="comment"></textarea>
...
<div class="col-xs-12 col-xs-offset-5 col-md-12 col-md-offset-6" >
