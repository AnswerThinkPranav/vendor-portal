...
<%  
	...
	/*if(!portalEmail.equals(eemail))
	{
		String query_E	= "UPDATE EZC_USERS set EU_EMAIL='"+eemail+"' where EU_ID='"+user+"'";	
		ezc.ezparam.EzcParams mainParams_E = new ezc.ezparam.EzcParams(true);
		EziMiscParams miscParams_E = new EziMiscParams();
		miscParams_E.setQuery(query_E);
		mainParams_E.setObject(miscParams_E);	
		Session.prepareParams(mainParams_E);
		
		try
		{
			miscManager.ezUpdate(mainParams_E);
		
		}
		catch(Exception e){ezc.ezcommon.EzLog4j.log("::::Error Occured While Updating Email ID in EZC_USERS Table:::::"+e,"I");}
	}*/
%>
<%
				...
				<div class="box-header  with-border" >
					...
					<div class="box box-success">
						...
						<div class="box-body chat" id="chat-box">
							...
							<center> <font color="#FF6600" size=3"><strong> At the time of submitting <br>
							soft copies of bills in vendor portal,<br>
							 attach all acknowledgements/supporting<br>
							 in PDF format only,this will help in  <br>
							
							faster invoice processing<br>
					...
					<div class="box box-success">
						...
						<div class="box-body chat" id="chat-box">
							<p class="message">	 
							<marquee scrollamount="2" direction="up" loop="true">
							<center> <font color="#FF6600" size=3"><strong>After submitting soft copy in portal, when you print the invoice,<br>
							for submission of Hard copy to SSC, ensure to download<br>
							it by clicking “PDF Download”.<br>
							This will enable us to get Portal reference and workflow number along with Bar Code<br>
					...
					<div class="box box-success">
						...
						<div class="box-body chat" id="chat-box">
							<p class="message">	 
							<marquee scrollamount="2" direction="up" loop="true">
							<center> <font color="#FF6600" size=3"><strong>For Primary & Secondary Freight, we have disabled the
							<br>edit options for Destination, Qty, Rate ,distance and Amount fields. <br>
							In case of difference in these fields with your actual invoice while submitting invoices,<br>
							please get in touch with your respective branch/logistics contact for fixing the issue.
