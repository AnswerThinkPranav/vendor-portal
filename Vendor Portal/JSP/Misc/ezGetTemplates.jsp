...
<br>
	...
	%>	 
			...
			<!--<Td><a href="ezUpdateTemplates.jsp?template=<%=template%>"><%=template%></a></Td>-->
			<Td><a href="ezUpdateTemplates.jsp?compCode=<%=compCode%>&category=<%=category%>&plant=<%=plant%>&docType=<%=docType%>&template=<%=template%>"><%=template%></a></Td>
