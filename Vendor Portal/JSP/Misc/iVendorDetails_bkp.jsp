...
<%		
	...
	ReturnObjFromRetrieve pmntObj_M	=  null;
	int    pmntObj_MTmCnt	=  0;
	ezc.ezparam.EzcParams mainParams7	= new ezc.ezparam.EzcParams(false);
	EziMiscParams miscParams7		= new EziMiscParams();
	miscParams7.setQuery("select * from ezc_master_key_values where EMKV_MASTER_TYPE='PMNT_TERM' and EMKV_VALUE1='M'") ;
	mainParams7.setLocalStore("Y");
	mainParams7.setObject(miscParams7);
	Session.prepareParams(mainParams7);
	try
	{		
		pmntObj_M=(ReturnObjFromRetrieve)ezMiscManager.ezSelect(mainParams7);
	}
	catch(Exception e){ezc.ezcommon.EzLog4j.log("::::Error Occured While Getting Payment Terms:::::"+e,"I");}
	if(pmntObj_M!=null)
		pmntObj_MTmCnt=pmntObj_M.getRowCount();
		
	ReturnObjFromRetrieve pmntObj_NM	=  null;
		int    pmntObj_NMTmCnt	=  0;
		ezc.ezparam.EzcParams mainParams7_2	= new ezc.ezparam.EzcParams(false);
		EziMiscParams miscParams7_2		= new EziMiscParams();
		miscParams7_2.setQuery("select * from ezc_master_key_values where EMKV_MASTER_TYPE='PMNT_TERM' and EMKV_VALUE1=''") ;
		mainParams7_2.setLocalStore("Y");
		mainParams7_2.setObject(miscParams7_2);
		Session.prepareParams(mainParams7_2);
		try
		{		
			pmntObj_NM=(ReturnObjFromRetrieve)ezMiscManager.ezSelect(mainParams7_2);
		}
		catch(Exception e){ezc.ezcommon.EzLog4j.log("::::Error Occured While Getting Payment Terms:::::"+e,"I");}
		if(pmntObj_NM!=null)
		pmntObj_NMTmCnt=pmntObj_NM.getRowCount();
