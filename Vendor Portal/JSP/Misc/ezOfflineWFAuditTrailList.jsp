...
<html>
<head>
<Title>WorkFlow Audit Trail List For Document:<%=docId%></Title>
...
<%
	String display_header = "Audit Trail For Document <font color='#FFFFFF'>"+docId+"</font>" ;//"QCF Audit Trail For Collective RFQ No:<font color='#FFFFFF'>"+docId+"</font>";
%>	
<!--
<Table style="background-color:#95b2c1" id="header" width="100%" border="1" align="center">
...
<%
	if(request.getParameter("wf_trail_list")!=null && !"null".equals(request.getParameter("wf_trail_list")))
	{
		...
		{
%>	
			<Table align=center width="98%" class=tableClass border=1 borderColorDark=#ffffff borderColorLight=#000000 cellPadding=5 cellSpacing=0>
			<Tr>
				<Th width="100%"  align="center"><%=display_header%></Th>
			<Tr>
			</Table>
			<Div id="theads">
			<Table id="tabHead" align=center width="98%" class=tableClass border=1 borderColorDark=#ffffff borderColorLight=#000000 cellPadding=5 cellSpacing=0>
				<Tr>
			...
			<Table id="InnerBox1Tab" width="100%" align=center  class=tableClass border=1 borderColorDark=#ffffff borderColorLight=#000000 cellPadding=5 cellSpacing=0>
<%
				String comments = "";
...
%>
					<Tr>
						...
						<Td width="25%" align="center"><%=fd.getStringFromDate((Date)retGetWFAuditTrailNos.getFieldValue(i,"EWAT_DATE"),(String)session.getValue("DATESEPERATOR"),Integer.parseInt((String)session.getValue("DATEFORMAT")))%>&nbsp;&nbsp;<%=retGetWFAuditTrailNos.getFieldValue(i,"AUDIT_TIME")%></Td> 
...
%>
			<DIV style="position:absolute;width:100%;height:40%;top:45%">
				<Table align="center" style="width:50%" border=1 borderColorDark=#ffffff borderColorLight=#000000 cellPadding=5 cellSpacing=0>
					<Tr>
