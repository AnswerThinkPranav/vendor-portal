5<%@ page import="ezc.ezmisc.params.*,ezc.ezparam.*" %>
...
<input type="hidden" name="pmntObj" id="pmntObj" value="<%=pmntObj%>">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						<table class="table table-bordered">
						 <tr>
							   ...
							   <th align="left">Phone Number <font color="red">*</font> </th>
							    <td>
								<input type="text" class="form-control validate[required]" data-errormessage-value-missing="Please Enter Phone Number" name="phoneNum" value="<%=checkNull(PhoneNumber)%>" maxlength="50">
							    </Td>
						</tr>
						<tr>
							    ...
							    <td>
								<input type="number" class="form-control validate[required]" name="postalCode" value="<%=checkNull(PostalCode)%>" maxlength="50">
							    </Td>
						...
						<tr>
							    ...
							    <td>
								<Select name="country" id="country" class="form-control input-sm validate[required]" data-errormessage-value-missing="Please Enter country" name="country" >
...
%>
						...
						<tr>
							   <th align="left">Address Line 5</th>
							    ...
							    <td>
								<Select name="state" id="state" class="form-control input-sm validate[required]" data-errormessage-value-missing="Please Enter state" name="state" >
						...
						<tr>
							   <th align="left">Email Address-1 <font color="red">*</font></th>
							    <td>
						...
						<th align="left">Email Address-2</th>
						<td>
					...
					<div class="box-body">
						<table id="contactTab" class="table table-bordered">
							<tr>
								    ...
								    <Th align="left">Title<font color="red">*</font></Th> 
								    <th align="left">Main Contact Person(s) <font color="red">*</font></th>
...
%>					
				...
				<Tr>
					<Th align="left">Copy of PAN card Attached</Th>
					<Td>
...
%>
				...
				<Tr>
					<Th align="left"> GSTIN Number of Business <font color="red">*</font></Th>
					<Td>
						<input type="text" onchange="validateGST()" class="form-control " data-errormessage-value-missing="Please Select GSTIN Number of Business"   id="gst_Number" name="gst_Number"  value="<%=checkNull(GST_Number)%>" maxlength="100" >
					</Td>
...
%>					
	...
	<Tr>
			<Th align="left">Businees Status of Vendor  <font color="red">*</font> </Th>
			<Td colspan="3">
				<div class="form-check">
<%
...
%>					  
				...
				<Tr>
					<Th align="left">E-Invoicing(Applicable if annual turnover in previous year is in excess of Rs.10 Cr. )</Th>
					<Td colspan="3">
						<div class="form-check">
<%
...
%>							
				...
				<Tr>
					<Th align="left">Is Supplier Currently Created with Other Jubilant Entities</Th>
					<Td colspan="3">
						<div class="form-check">
<%
...
%>						
				...
				<Tr>
					<Th align="left">Is Supplier done any transaction earlier with Hackett with any other name or related concerns firm</Th>
					<Td colspan="3">
						<div class="form-check">
<%
...
%>						
				...
				<Tr>
					<Th align="left">Vendor Site Visit Performed</Th>
					<Td colspan="3">
<%
...
%>					
	...
	<table class="table table-bordered">
			<Tr>
				<Th align="left" width="30%">Income Tax Return </Th>
				<Td width="20%">
...
%>
		...
		<table class="table table-bordered">
		<Tr>
				<Th align="left" width="30%">MOA & AOA </Th>
				<Td width="20%">
...
%>
		...
		<table class="table table-bordered">
			<Tr>
				<Th align="left" width="30%">Certified copy of Supply agreement or <br>proposal attached </Th>
				<Td width="20%">
...
%>
				...
				<Tr>
					<Th align="left">Cancelled Cheque <font color="red">*</font> </Th>
					<Td>
...
<%
	...
	{
	ReturnObjFromRetrieve retUploadList = getUploadList(Session,docId,""); 
	ezc.ezcommon.EzLog4j.log("retUploadList:::::"+retUploadList.toString(),"I");
	int retUploadListCnt = 0; 
	String itemId="H";
	if(retUploadList != null)
		retUploadListCnt = retUploadList.getRowCount();
		ezc.ezcommon.EzLog4j.log("retUploadListCnt:::::"+retUploadListCnt,"I");
%>
...
%>
		<Table align="center" width="100%" border=1 borderColorDark=#ffffff borderColorLight=#006666 cellPadding=2 cellSpacing=0 >
			...
			<Tr>	
				<Td class='blankcel p-5' width='100%' style="padding: 10px">
				<textarea  name = 'comments' id='comments' style=' position:relative; width:100%' rows=3 cols=73 class="position-relative" ></textarea>
				</Td>
			</Tr> 
		</Table>
<%
...
<%
	...
	{
%>	
				<button type="button" class="btn btn-primary" onclick="funSubmit('U')" style="margin-right: 5px;"><i class="fa fa-submit"></i>&nbsp;Re-Submit</button>	
<%				
	}
	if(showSubmit)
	{
...
%>				
				<button type="button" class="btn btn-primary" onclick="funShowApprovalHirearchy('<%=compCode%>','<%=venWFPlant%>','<%=venWFCategory%>','0')" style="margin-right: 5px;"><i class="fa fa-users"></i> Show Approval Hirearchy</button>
...
<div id="woModal" class="modal fade" tabindex="-1" role="dialog" style="opacity:1!important">  
   <div class="modal-dialog" style="top: 15rem">
      <div class="modal-content" style="width:700px">
         <div class="modal-body">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true" onclick="closeIframe()">&times;</button>
            <div>
...
<div id="woModalResp" class="modal fade" tabindex="-1" role="dialog" style="opacity:1!important"  aria-hidden="true">  
	<div class="modal-dialog" style="top: 10rem">
		<div class="modal-content" style="width:600px">
			...
			<div class="modal-body" id="modal-body-resp">
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="closeIframeResp()">Close</button>
			</div>
		</div>
	</div>
</div>
<div id="uploadMod" class="modal fade" tabindex="-1" role="dialog" style="opacity: 1!important"> //added by Pratik
   <div class="modal-dialog">
      <form id="uploadForm" action="../Inbox/ezUploadFile.jsp" method="post" enctype="multipart/form-data">
      <div class="modal-content">
      <div class="modal-header">
	      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
		<span aria-hidden="true" id="closeModalBtn">x</span></button>
	      <h4 class="modal-title">Attachments</h4>
	</div>
	 <div class="modal-body" aria-hidden="true" id="uploadDialogBtn">	     
	         <fieldset>  
...
<div id="uploadModTemp" class="modal fade" tabIndex="-1" role="modal" aria-modal="true">
   <div class="modal-dialog">
...
%>
		...
		$( function() {
		     ...
		     $( ".uploadDialogBtn" ).button().on( "click", function() {
			  ...
			  //alert("alerttest"+msg);
				  ...
				  $('#'+'uploadTableH').append('<tr><td><span><input type="hidden" id="fileItem" name="fileItem" value="'+fileNameTemp+'"><a href="javascript:downloadFile(\'O\',\''+upDocItemNo+'\',\''+fileNameTemp+'\',\''+docType+'\')">'+fileNameTemp+'</a></span></td><td><span onclick="javascript:deleteFile(this,\''+upDocItemNo+'\',\''+fileNameTemp+'\',\''+docType+'\')" class="fa fa-trash fa-lg deleteBtn" style="margin-left: 25%;"></span></td>');
			      }
								...
								else
								{
									...
									if(role == "VAR")
									{
										...
										$.ajax({
											...
											if(result.split("#")[1] == "Q")
											{
											    var msg =  result.split("#")[2];
											    //alert("msg>>>"+msg);
											    $('#modal-body-resp').html(msg);
											    $('#woModalResp').modal('show');
											    //return;
											}
											else
											{
	...
	function closeIframeResp()
	{
	   $('#woModalResp').modal('hide');
	}	
