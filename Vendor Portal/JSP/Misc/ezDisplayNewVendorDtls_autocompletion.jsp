...
<input type="hidden" name="AcctGroup" value="">
<input type="hidden" name="ReconAcct" value="">
...
<!-- Content Wrapper. Contains page content -->
      <Div class="content-wrapper">
		...
		%>
            ...
            <br>
            <B><Font size=4 color=BLACK>Account Group/Recon Account</Font></B>		
		      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;		
		<Input  type="text"   name="accountGrpReconAcct" id="accountGrpReconAcct"  value="" onKeyUp="funClick()" style="width:60%" >	

	       <!--          <B><Font size=4 color=BLACK>Account Group</Font></B>
	                  
              &nbsp;&nbsp;&nbsp;&nbsp;
              <select name="AcctGroup" id="AcctGroup" style="width:25%">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<B><Font size=4 color=BLACK>Serach Term</Font></B>		
			      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;		
			<Input  type="text"   name="scTerm" id="scTerm" value="<%=searchTerm%>"  maxlength="35" >	
			<br><br>
...
if(document.myForm.AcctGroup.value=="")
	...
	/*if(document.myForm.CompanyCode.value=="")
	{
