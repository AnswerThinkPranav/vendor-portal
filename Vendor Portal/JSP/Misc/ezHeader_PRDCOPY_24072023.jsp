...
%> 
			<li class="treeview"> 
				...
				<a id="rfqMenu" href="#"><i class="fa fa-newspaper-o"></i> <span>RFQs</span> <i class="fa fa-angle-left pull-right"></i></a> 
					<ul class="treeview-menu">
...
<%
	...
	else if("2".equals(v_UserType) && isNABuyer)
	{
%>
		<li class="treeview"> 
			<a href="#"><i class="fa fa-edit"></i> <span>Vendor Registration</span> <i class="fa fa-angle-right pull-right"></i></a> 
			<ul class="treeview-menu">
<%
		if("PP".equals(userRole) || "BY".equals(userRole))
		{
			...
			{
%>				
				<li><a href="../Misc/ezTempNAUserCreation.jsp"><%=munuIetmIcon%>Invite Vendor</a></li>
<%				
			}else{
%>
				<li><a href="../Misc/ezTempUserCreation.jsp"><%=munuIetmIcon%>Invite Vendor</a></li>
<%
			}
%>					
				<li><a href="../Misc/ezTempVendList.jsp?type=ALL&venType=IN""><%=munuIetmIcon%>New</a></li>
<%
		}
%>				
				<!--<li><a href="../Misc/ezListVendReg.jsp?type=Act&menuItem=vendReg"><%=munuIetmIcon%>List</a></li>-->
				<li><a href="../Misc/ezVNRList.jsp?type=ALL&venType=IN"><%=munuIetmIcon%>List</a></li>	
<%
...
%>				
		...
		<li class="treeview"> 
			<a id="tatMenu" href="#"><i class="fa fa-bar-chart"></i> <span>Reports</span> <i class="fa fa-angle-left pull-right"></i></a> 
			<ul class="treeview-menu">
				<li><a href="../Misc/ezVNRList.jsp?type=Apr&venType=IN"><%=munuIetmIcon%><span>Vendor Registration Report</span></a></li>
			</ul>
		</li>	
<%
	}
...
%>
			<li class="treeview"> 
				<a id="rfqMenu" href="#"><i class="fa fa-newspaper-o"></i> <span>Budget Price</span> <i class="fa fa-angle-right pull-right"></i></a> 
				<ul class="treeview-menu">
					<li><a href="../RFQ/ezListFYMatBudgetPrice.jsp"><%=munuIetmIcon%>List</a></li>
					<li><a href="../RFQ/ezPriceUpload.jsp"><%=munuIetmIcon%>Upload</a></li>
				</ul>	
			<li>
			<li class="treeview">
				<a id="rfqMenu" href="#"><i class="fa fa-newspaper-o"></i> <span>RFQs</span> <i class="fa fa-angle-left pull-right"></i></a> 
 		  		<ul class="treeview-menu">
 		  		  <li><a href="../RFQ/ezPrePRList.jsp?Status=R">From PRs</a></li>
 		  		  <li><a href="../Request/ezSelectAuctionMat.jsp?from=RFQ">From Material</a></li>
 		  		  <!--<li><a href="../RFQ/ezCreateRFQFromMat.jsp">From Material</a></li>-->
 		  		  <li><a href="../RFQ/ezListRFQs.jsp?type=ALL&rfqType=DOM">RFQ List</a></li>				
				</ul>
			</li>
<%
		}
...
%>
			<li class="treeview">
				<li><a  id="rfqMenu" href="../RFQ/ezListRFQs.jsp?type=ALL&rfqType=DOM"><i class="fa fa-newspaper-o"></i> <span>RFQs</span></a></li>							
			<li>
<%
		}
%>			
...
<%
		if(!"VAR".equals(userRole))
		{
			...
			{
%>			
 				  <a  id="qcfmenu" href="#"><i class="fa fa-newspaper-o"></i> <span>QCFs</span><i class="fa fa-angle-left pull-right"></i></a> 			
 				  <ul class="treeview-menu">
 				  <li><a href="../RFQ/ezListQcfs.jsp?type=New&rfqType=DOM">List</a></li>
 				  <li><a href="../RFQ/ezQCSList.jsp?type=Sub">To Act</a></li>
 				  <!--<li><a href="../RFQ/ezQCFPOList.jsp">PR-PO Report</a></li>-->
 				  </ul>
<%
			}else if("VIW".equals(userRole)){
%>
				  <li><a  id="qcfmenu" href="../RFQ/ezAuditQCSList.jsp?type=ALL"><i class="fa fa-newspaper-o"></i> <span>QCFs</span></a></li>							
<%
			}else{
%>
				  <li><a  id="qcfmenu" href="../RFQ/ezQCSList.jsp?type=Act"><i class="fa fa-newspaper-o"></i> <span>QCFs</span></a></li>							
				  <!--<li><a  id="pomenu" href="../RFQ/ezQCFPOList.jsp"><i class="fa fa-newspaper-o"></i> <span>PR-PO Report</span></a></li> -->	
<%				
			}
%>			
 			<li class="treeview"> 
...
<%
		...
		{
%>
					<li><a href="../Request/ezSelectAuctionMat.jsp?from=AUCT">Create</a></li>
					<li><a href="../Request/ezAuctionQCFs.jsp?">Create From QCF</a></li>
					<li><a href="../Request/ezListAuctionRequests.jsp?type=Main">List</a></li>
<%
		}
%>
					...
					<li><a href="../Request/ezListActiveAuctions.jsp">Current Auctions</a></li>
					<li><a href="../Request/ezListAuctionRequests.jsp?type=Closed">Completed Auctions</a></li>
					<li><a href="../Request/ezAuctionList.jsp?type=ALL">Submitted Auctions</a></li>
<%
					if("PP".equals(userRole))
					{
%>
					<li><a href="../Request/ezAuctionPendingForPO.jsp">Create PO</a></li>
					<li><a href="../MasterData/ezAddDestination.jsp">Destination</a></li>
<%
					}
%>
					<li><a href="../Request/ezAuctionLogs.jsp?type=ALL">Logs</a></li>
...
%>			
 				<li class="treeview"> 
					<a id="tatMenu" href="#"><i class="fa fa-bar-chart"></i> <span>Reports</span> <i class="fa fa-angle-left pull-right"></i></a> 
					<ul class="treeview-menu">
						<li><a href="../RFQ/ezRfqMisReport.jsp?selPlant=ALL"><%=munuIetmIcon%><span>RFQ Report</span></a></li>
						<li><a href="../RFQ/ezQCFPOList.jsp?selPlant=ALL"><%=munuIetmIcon%><span>PR-PO Report</span></a></li>
						<li><a href="../RFQ/ezTatReport.jsp?selPlant=ALL"><%=munuIetmIcon%><span>TAT Report</span></a></li>
						<li><a href="../Request/ezAuctionPOList.jsp?selPlant=ALL"><%=munuIetmIcon%><span>Auction_PO Report</span></a></li>
						<li><a href="../Misc/ezVNRList.jsp?type=Apr&venType=IN"><%=munuIetmIcon%><span>Vendor Registration Report</span></a></li>
<%	
			if("VIW".equals(userRole))
			{
%>			
						<li><a href="../Misc/ezListWebStats.jsp?type=ALL"><%=munuIetmIcon%><span>User WebStats</span></a></li>
<%
			}
%>						
					</ul>
...
%>		
			<li class="treeview">
				<a href="#"><i class="fa fa-file-text"></i> <span>Amendments[POs]</span> <i class="fa fa-angle-right pull-right"></i></a> 
				<ul class="treeview-menu">
					<li><a href="../Purorder/ezListUnreleasedPOs.jsp"><%=munuIetmIcon%>Ammended POs</a></li>
					<li><a href="../Purorder/ezSubmittedPOs.jsp?type=ALL"><%=munuIetmIcon%>Submitted POs</a></li>
...
<%
		...
		{
%>
			<!--<li><a href="../Misc/ezVendReg.jsp"><i class="fa fa-edit"></i> <span>Registration Form</span></a></li>-->
			<li><a href="../Misc/ezPageRedirect.jsp"><i class="fa fa-edit"></i> <span>Registration Form</span></a></li>
