...
<Head>
<Script>
function funPopup(comm,qtr,yr)
{

	window.open("../Misc/ezViewComments.jsp?comm="+comm+"&qtr="+qtr+"&yr="+yr,"UserWindow1","width=450,height=370,left=150,top=250,resizable=yes,scrollbars=no,toolbar=no,menubar=no");
}
</Script>
</Head>
<Body>
...
%>
	...
	%>	
					<Tr>
						...
						<a href="javascript:funPopup('<%=comments%>','<%=quarter%>','<%=year%>')">Click</a>
