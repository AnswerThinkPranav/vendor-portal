...
%>		
		...
		<li class="treeview"> 
			<a href="#"><i class="fa fa-edit"></i> <span><%=vend_Reg_L%></span> <i class="fa fa-angle-right pull-right"></i></a>
			<ul class="treeview-menu">
<%
		if("PP".equals(userRole) || "BY".equals(userRole))
		{
			...
			{
%>				
				<li><a href="../Misc/ezTempNAUserCreation.jsp"><%=munuIetmIcon%><%=invite_Vend_L%></a></li>
<%				
			}else{
%>			
				<li><a href="../Misc/ezTempUserCreation.jsp"><%=munuIetmIcon%><%=invite_Vend_L%></a></li>
<%
			}
%>			
...
%>
			<li class="treeview"> 
				<a id="rfqMenu" href="#"><i class="fa fa-newspaper-o"></i> <span><%=bud_Price_L%></span> <i class="fa fa-angle-left pull-right"></i></a> 
				<ul class="treeview-menu">
			...
			<li class="treeview">
				<a id="rfqMenu" href="#"><i class="fa fa-newspaper-o"></i> <span><%=RFQs_L%></span> <i class="fa fa-angle-left pull-right"></i></a> 
 		  		<ul class="treeview-menu">
 		  		  <li><a href="../RFQ/ezPrePRList.jsp?Status=R"><%=from_PRs_L%></a></li>
 		  		  <!--<li><a href="../RFQ/ezPrStatus.jsp?Status=R">PR Status</a></li>-->
 		  		  <li><a href="../Request/ezSelectAuctionMat.jsp?from=RFQ"><%=from_mat_L%></a></li>
 		  		  <li><a href="../RFQ/ezListRFQs.jsp?type=ALL&rfqType=DOM"><%=RFQ_list_L%></a></li>				
...
%>			
 				  ...
 				  <li><a href="../RFQ/ezQCSList.jsp?type=Sub"><%=to_act_L%></a></li>
 				  <li><a href="../RFQ/ezQCFPOList.jsp"><%=PR_PO_Report_L%></a></li>
 				  </ul> 				  
<%
				}else{
%>
				<a  id="qcfmenu" href="../RFQ/ezQCSList.jsp?type=ALL"><i class="fa fa-newspaper-o"></i> <span>QCFs</span></a> 	
				<a  id="pomenu" href="../RFQ/ezQCFPOList.jsp"><i class="fa fa-newspaper-o"></i> <span><%=pur_Order_L%></span></a> 	
...
%>	
 			...
 			<li class="treeview"> 
			<a id="rfqMenu" href="#"><i class="fa fa-newspaper-o"></i> <span><%=auction_L%></span> <i class="fa fa-angle-left pull-right"></i></a> 
				<ul class="treeview-menu">
					<li><a href="../Request/ezSelectAuctionMat.jsp?from=AUCT"><%=create_L%></a></li>
					<li><a href="../Request/ezAuctionQCFs.jsp?"><%=create_from_QCF_L%></a></li>
					...
					<li><a href="../Request/ezListActiveAuctions.jsp"><%=curr_auc_L%></a></li>
					<li><a href="../Request/ezListAuctionRequests.jsp?type=Closed">Completed Auctions<%//=comp_auc_L%></a></li>
					<li><a href="../Request/ezAuctionList.jsp?type=ALL"><%=sub_auction_L%></a></li>
					<li><a href="../Request/ezAuctionPendingForPO.jsp"><%=create_PO_L%></a></li>
			...
			<li class="treeview"> 
				...
				<ul class="treeview-menu">
					<li><a  id="pomenu" href="../RFQ/ezRfqMisReport.jsp?selPlant=ALL"><%=munuIetmIcon%><span><%=RFQ_report_L%></span></a></li>
					<li><a  id="pomenu" href="../RFQ/ezQCFPOList.jsp"><%=munuIetmIcon%><span><%=PR_PO_Report_L%></span></a></li>
					<li><a href="../RFQ/ezTatReport.jsp"><%=munuIetmIcon%><span><%=TAT_Report_L%></span></a></li>
					<li><a href="../Request/ezAuctionPOList.jsp"><%=munuIetmIcon%><span><%=auc_PO_Report_L%></span></a></li>
					<li><a href="../RFQ/ezMatPrices.jsp"><%=munuIetmIcon%><span>PriceTrends</span></a></li>
<%	
			if("VIW".equals(userRole))
			{
%>					
					<li><a href="../Misc/ezVendRegReport.jsp?type=Apr&venType=IN"><%=munuIetmIcon%><span><%=vend_Reg_Report_L%></span></a></li>
<%
			}else{
%>
					<li><a href="../Misc/ezVNRList.jsp?type=Apr&venType=IN"><%=munuIetmIcon%><span><%=vend_Reg_Report_L%></span></a></li>
<%
			}
%>					
				</ul>
...
%>		
			<li class="treeview">
				<a href="#"><i class="fa fa-file-text"></i> <span><%=pur_Order_L%></span> <i class="fa fa-angle-right pull-right"></i></a> 
				<ul class="treeview-menu">
					<li><a href="../Purorder/ezListUnreleasedPOs.jsp"><%=munuIetmIcon%><%=ammen_PO_L%></a></li>
					<li><a href="../Purorder/ezSubmittedPOs.jsp?type=ALL"><%=munuIetmIcon%><%=sub_PO_L%></a></li>
...
<%
	...
	{
%>
		<li><a href="../Misc/ezPassword.jsp?fromMenu=Y"><i class="fa fa-key"></i> <span><%=change_Pwd_L%></span></a></li>
