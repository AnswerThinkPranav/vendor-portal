...
//out.println("::::::::"+titleSel+name1+name2+addr1+addr2+""+street+city+state+country+district+pin+landline+mobile+fax+email+email2+contPers1+contPers2);
...
String template="";
	...
	if("".equals(userGroupKey))userGroupKey="VENDGRP";
...
try
{
	if(!"".equals(vendorProfileId))
	{
		...
		dispMessage="Your request has been submitted succesfully to coromandel.<br> Request No: "+vendorProfileId;
		dispMsgType="S";
		...
		if("Y".equals(attachflag))
		{
			...
			try
			{
				...
				srcPath="D:\\EZC\\EzUpload\\";//site1.getString("UPLOADDIR");
				//srcPath="D:\\usr\\sap\\VMP\\J00\\j2ee\\cluster\\apps\\answerthink.com\\EzCFL\\servlet_jsp\\CFL\\root\\Uploads\\";//site1.getString("UPLOADDIR");
			}
			catch(Exception e)
			{ 
...
//						destFolder	= new File("D:\\EZC\\EzCom\\Upload\\"+vendorProfileId);
						destFolder	= new File("D:\\usr\\sap\\VMP\\J00\\j2ee\\cluster\\apps\\answerthink.com\\EzCFL\\servlet_jsp\\CFL\\root\\Uploads\\"+vendorProfileId);
