  ...
  <!-- Content Wrapper. Contains page content -->
        <Div class="content-wrapper">
          ...
          <section class="content-header">
            <h4>
             Self Service > View/Change profile > Vendor Details  </h4><br>
			...
			<Div class="box-body" style="display: block;">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<Input  type="text"  class="form-control" name="vendCode" id="vendCode" value="<%=Integer.parseInt(vendCode)%>" readonly disabled >
					...
					<div class="form-group">
						...
						<Input  type="text"  class="form-control"  name="compCode" id="compCode" value="<%=compCode%>" disabled>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<Input  type="text" class="form-control"  name="venName" id="venName" value="<%=venName%>"   disabled >
						<Input  type="hidden"   name="venName_old" id="venName_old" value="<%=venName%>"> 
					</div>
					<div class="form-group" style="padding-top: 20px;">
						<label for="exampleInputEmail1">Service Based</label>
						<Input  type="radio"   name="serBased" id="serBased" value="Y"  maxlength="1" disabled <%=("X".equals(serBased)) ? "CHECKED" : ""%>>&nbsp;Yes &nbsp;&nbsp;&nbsp;
						<Input  type="radio"   name="serBased" id="serBased" value="N"  maxlength="1" disabled <%=("".equals(serBased)) ? "CHECKED" : ""%>>&nbsp;No											
						<Input  type="hidden"   name="serBased_old" id="serBased_old" value="<%=("".equals(serBased)) ? "N" : "Y"%>" >
					</div>
				</div>	
				<div class="col-md-4">
					<div class="form-group" style="padding-top: 20px;">
						<label for="exampleInputEmail1">GR Based</label>
						<Input  type="radio"   name="grBased" id="grBased" value="Y"  maxlength="1" disabled <%=("X".equals(grBased)) ? "CHECKED" : ""%>>&nbsp;Yes &nbsp;&nbsp;&nbsp;
						<Input  type="radio"   name="grBased" id="grBased" value="N"  maxlength="1" disabled <%=("".equals(grBased)) ? "CHECKED" : ""%>>&nbsp;No
...
<div class="col-md-4">
	<div class="form-group">
				...
				<Input class="form-control" type="text"   name="titleSel" id="titleSel" value="<%=titleSel%>"  maxlength="35" disabled>				
	</div>					
	<div class="form-group">
		<label for="exampleInputEmail1">Addr1 / H.No</label>		
		<Input  type="text" class="form-control" style="text-transform: uppercase;"  name="addr1" id="addr1" value="<%=addr1%>"  maxlength="35">
		<Input  type="hidden"   name="addr1_old" id="addr1_old" value="<%=addr1%>" >
	</div>
	<div class="form-group">
		<label for="exampleInputEmail1">City</label>		
		<Input  type="text" class="form-control" style="text-transform: uppercase;"  name="city" id="city" value="<%=city%>"  maxlength="35">
		<Input  type="hidden"   name="city_old" id="city_old" value="<%=city%>">
	</div>
	<div class="form-group">
		<label for="exampleInputEmail1">District</label>		
		<Input  type="text" class="form-control" style="text-transform: uppercase;"  name="district" id="district" value="<%=district%>"  maxlength="35">
		<Input  type="hidden"   name="district_old" id="district_old" value="<%=district%>">
	</div>
	<div class="form-group">
		<label for="exampleInputEmail1">Landline</label>		
		<Input  type="text" class="form-control"  name="landline" id="landline" value="<%=landline%>"  maxlength="16">
		<Input  type="hidden"   name="landline_old" id="landline_old" value="<%=landline%>">
	</div>
	<div class="form-group">
		<label for="exampleInputEmail1">EMail</label>		
		<Input  type="text" class="form-control"  name="email" id="email" value="<%=email%>"  maxlength="241">
	...
	<div class="form-group">
		...
		<Input  type="text" class="form-control" style="text-transform: uppercase;"  name="contPers1" id="contPers1" value="<%=contPers1%>"  maxlength="35">
...
<div class="col-md-4">
	<div class="form-group">
		...
		<Input  type="text"  class="form-control"   name="name1" id="name1" value="<%=name1%>"  maxlength="35" readonly disabled>
		<Input  type="hidden"   name="name1_old" id="name1_old" value="<%=name1%>" >
	</div>					
	<div class="form-group">
		<label for="exampleInputEmail1">Addr2</label>
		<Input  type="text"  class="form-control" style="text-transform: uppercase;"  name="addr2" id="addr2" value="<%=addr2%>"  maxlength="35">
	...
	<div class="form-group">
		...
		<Input  type="text"  class="form-control"   name="pin" id="pin" value="<%=pin%>"  maxlength="6">
		<Input  type="hidden"   name="pin_old" id="pin_old" value="<%=pin%>">
	</div>
	<div class="form-group">
		<label for="exampleInputEmail1">Mobile</label>				
		<Input  type="text"  class="form-control"  name="mobile" id="mobile" value="<%=mobile%>"  maxlength="16">
		<Input  type="hidden"   name="mobile_old" id="mobile_old" value="<%=mobile%>">
	</div>					
	<div class="form-group">
		<label for="exampleInputEmail1">EMail 2</label>
		<Input  type="text"  class="form-control"  name="email2" id="email2" value="<%=email2%>"  maxlength="241">
		<Input  type="hidden"   name="email2_old" id="email2_old" value="<%=email2%>" >
		<p id="emailMsg" style="display:none"><font color="red">Please enter valid Email Id</font></p>
	</div>	
	<div class="form-group">
			<label for="exampleInputEmail1">Contact Person 2</label>
			<Input  type="text"  class="form-control" style="text-transform: uppercase;"  name="contPers2" id="contPers2" value="<%=contPers2%>"  maxlength="35">
...
<div class="col-md-4">
	<div class="form-group">
		...
		<Input  type="text" class="form-control"  name="name2" id="name2" value="<%=name2%>"  maxlength="35" readonly disabled>
		<Input  type="hidden"   name="name2_old" id="name2_old" value="<%=name2%>">
	</div>					
	<div class="form-group">
		<label for="exampleInputEmail1">Street</label>
		<Input  type="text" class="form-control" style="text-transform: uppercase;"  name="street" id="street" value="<%=street%>"  maxlength="60">
	...
	<div class="form-group">
		...
		<Input  type="text" class="form-control"   name="fax" id="fax" value="<%=fax%>"  maxlength="31">
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				<Input  type="text" class="form-control"  style="text-transform: uppercase;" name="pan" id="pan" value="<%=pan%>"  maxlength="10" >						
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				<Input  type="text" class="form-control" style="text-transform: uppercase;"  name="gst" id="gst" value="<%=gst%>"  maxlength="15" onchange="funGst()">
...
<div class="col-md-4">
	<div class="form-group">
		<label for="exampleInputEmail1">Country</label>				
		<Input  type="text" class="form-control"  style="text-transform: uppercase;" placeholder="India--<%=bankCountry[k]%>"  maxlength="10" disabled>
	...
	<div class="form-group">
		<label for="exampleInputEmail1">Street</label>
		<Input  type="text" class="form-control" style="text-transform: uppercase;"  name="bankStreet" id="bankStreet" value="<%=bankStreet[k]%>"  maxlength="35">
		<input type="hidden" name="bankStreet_old" value="<%=bankStreet[k]%>">
	</div>
	<div class="form-group">
		<label for="exampleInputEmail1">IFSC Code</label>
		<Input  type="text" class="form-control" style="text-transform: uppercase;" name="bankIFSCCode" id="bankIFSCCode" value="<%=bankIFSCCode[k]%>"  maxlength="11">
...
<div class="col-md-4">
	<div class="form-group">
		...
		<Input  type="text" class="form-control" style="text-transform: uppercase;"  name="bankName" id="bankName" value="<%=bankName[k]%>"  maxlength="60">
		<input type="hidden" name="bankName_old" value="<%=bankName[k]%>">
	</div>	
	<div class="form-group">
		<label for="exampleInputEmail1">City</label>		
		<Input  type="text" class="form-control" style="text-transform: uppercase;"  name="bankCity" id="bankCity" value="<%=bankCity[k]%>"  maxlength="35">
		<input type="hidden" name="bankCity_old" value="<%=bankCity[k]%>">
	</div>	
	<div class="form-group">
		<label for="exampleInputEmail1">Account Number</label>		
		<Input  type="text" class="form-control" style="text-transform: uppercase;"  name="bankACCode" id="bankACCode" value="<%=bankACCode[k]%>"  maxlength="18">
...
<div class="col-md-4">
	...
	<div class="form-group">
			...
			<Input  type="text" class="form-control" style="text-transform: uppercase;"  name="bankBranch" id="bankBranch" value="<%=bankBranch[k]%>"  maxlength="40">
			<input type="hidden" name="bankBranch_old" value="<%=bankBranch[k]%>">
	</div>
	<div class="form-group">
		<label for="exampleInputEmail1">Currency</label>		
		<Input  type="text" class="form-control" style="text-transform: uppercase;"   placeholder="Rupee-- INR"  disabled>
...
<div class="col-md-4">
	<div class="form-group">
		<label for="exampleInputEmail1">Country</label>				
		<Input  type="text" class="form-control"  style="text-transform: uppercase;" value="India--IN"  maxlength="10" disabled>
		<input type="hidden" name="bankKey" value="<%=(Integer.parseInt(bankIndexStr)+1)+""%>">		
...
<div class="col-md-4">
	<div class="form-group">
		<label for="exampleInputEmail1">Bank Name</label>
		<Input  type="text" class="form-control" style="text-transform: uppercase;"  name="bankName" id="bankName" value=""  maxlength="60">
...
<div class="col-md-4">
	...
	<div class="form-group">
		<label for="exampleInputEmail1">Currency</label>		
		<Input  type="text" class="form-control" style="text-transform: uppercase;"   value="Rupee-- INR"  disabled>
		<Input  type="hidden"  name="bankCurrency" id="bankCurrency" value="INR">
		<Input  type="hidden"  name="bankCurrency_old" id="bankCurrency_old" value="INR">
	</div>
</div>
...
/*function funGst()
{
	...
	alert("gstCode"+gstCode+"gststatecode"+gststatecode);
	//alert(res+"::::::::"+pan)
	if(gstCode!=gststatecode)
	  ...
	  if(pan!=res){
	    alert("GST number does not match with PANN");
	    //document.myForm.gst.value="";
	  }
	if(gst!="" && pan==res)
	{
...
%>	
	...
	if( gst_old!=gst || minIndi_old!=minIndi ||  pan_old!=pan)
	{
...
<%
		...
		MinIndvalue = checkNull(retMinInd.getFieldValueString(i,"EMKV_VALUE"));
	%>
		 var minVal = "<%=MinIndvalue%>";
		 var minKey = "<%=MinIndkey%>";
		
			 if(minIndi==minKey)
			{
				minIndiNew=minIndi+" "+minVal;
			}
	<%
		}
...
%>
	...
	if(minIndi!=minIndi_old)
		changedValues=changedValues+"##"+"Category"+"$$"+minIndiNew;
	if(gst!=gst_old)
	...
	{	
		...
		for(i=0;i<bankObjLen;i++)
		{
			...
			if(bankACCode!=bankACCode_old)
 			...
 			//alert(attachType+":::::"+changedBankDetails);
			if(bankCurrency_old!=bankCurrency || bankACCode_old!=bankACCode || bankBranch_old!=bankBranch || bankIFSCCode_old!=bankIFSCCode || bankCountry_old!=bankCountry || bankName_old!=bankName || bankRegion_old!=bankRegion || bankStreet_old!=bankStreet || bankCity_old!=bankCity)
			{
				//if(bankACCode_old=="")
				changedBankDetails=bankACCode;
...
$(document).ready(function(){
	...
	$.validator.addMethod("contactper", function(value) {
	if(($('#contPers1').val() !== "" || $('#contPers2').val() !== "" ))
		return /^[a-zA-Z\s]+$/.test(value) 
			}, "Please enter only alphabets and space");
	
	$.validator.addMethod("gstinn", function(value) {
		 return /\d{2}[a-zA-z]{5}\d{4}[a-zA-z]{1}\d{1}[a-zA-z]{1}/.test(value) 
