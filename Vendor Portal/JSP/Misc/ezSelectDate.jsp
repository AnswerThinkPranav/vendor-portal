...
<Br>
 ...
 <%
 	...
 	if("2".equals(userType) && !"vendReg".equals(menuItem) && menuItem != null)
 	{
%>		
		<Th <%=trBGColorH%>>
			&nbsp;&nbsp;&nbsp;&nbsp;Vendor&nbsp;&nbsp;
...
<%
		...
		if("RFQ".equals(menuItem) || "ASN".equals(menuItem) || "STR".equals(menuItem) || ("PO".equals(menuItem) && (!"Open".equals(OrderType) && !"Closed".equals(OrderType))))
		{
%>
...
<%
		...
		String ven_Selected = "";
		if("RFQ".equals(menuItem) || "ASN".equals(menuItem))
		{
