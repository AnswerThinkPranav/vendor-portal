...
<%@ page import="ezc.ezmisc.params.*,ezc.ezparam.*,java.io.*,java.nio.channels.*" %>
...
String purpose = checkNull(request.getParameter("purpose"));
...
ezc.ezcommon.EzLog4j.log(":::::cerificateDate::::::"+cerificateDate,"I");

String comments  	 = checkNull(request.getParameter("comments"));
//out.println("::::::::"+vendCode+"<>"+compCode+"<>"+serBased+"<>"+grBased+"<>"+procGrp);
...
String state  	 	 = checkNull(request.getParameter("stateh"));
...
out.println(state+"::::::::"+titleSel+name1+name2+addr1+addr2+""+street+city+state+country+district+pin+landline+mobile+fax+email+email2+contPers1+contPers2);
...
ezc.ezcommon.EzLog4j.log(checkRole+"::::::::checkRole:::::::userGroupKey::::"+userGroupKey,"I");
	...
	mainParams.setLocalStore("Y");
ezc.ezcommon.EzLog4j.log(vendCode+":::::::vendCode::::"+vendCode,"I");
	...
	generalParams.setPurpose(purpose);
	...
	if ((bankACCode[k]==null)||(bankACCode[k].equals("")))
			continue;
			 ...
			 bankDetailsTableRow.setSerialNo(bankIndex[k]);
	...
	if(!"".equals(email))
	{
	vendorEmailTableRow = new EziVendorEmailTableRow();
	...
	if(!"".equals(email2) && !email.equals(email2))
	{
	vendorEmailTableRow = new EziVendorEmailTableRow();
	vendorEmailTableRow.setVendor(vendCode);
	vendorEmailTableRow.setAddrNr("123");
	vendorEmailTableRow.setEmail(email2);
	vendorEmailTable.appendRow(vendorEmailTableRow);
	}
...
//ezc.ezcommon.EzLog4j.log(vendorDtlsObj.toEzcString()+":::::vendorProfileId::::::::"+vendorProfileId,"I");
try
{
...
//						destFolder	= new File("D:\\EZC\\EzCom\\Upload\\"+vendorProfileId);
		...
		//String msgSubject = v_fname+v_mname+v_lname+" change profile submitted";
		String msgSubject = "Vendor Profile change request submitted (Request number "+myPurOrg+vendorProfileId+")";
		if(vendType.equals("NEW"))
		 //msgSubject = v_fname+v_mname+v_lname+" new profile submitted";
		msgSubject = "Vendor Profile creation request submitted (Request number "+myPurOrg+vendorProfileId+")";
		String msgText = "Dear Sir/Madam,<br><br> Vendor profile request "+myPurOrg+vendorProfileId+" has been submitted for your approval.&nbsp;<br>";
		//msgText = msgText+"<BR><br>Please Click on the below link to access the portal.";
		//msgText = msgText+"<BR>"+url;
