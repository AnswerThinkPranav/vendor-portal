...
<input type="hidden" name="vendType" value="<%=vendType%>">
...
<!-- general form elements -->
	...
	<div class="box-body">
		...
		<div>
		  <ul>
		    <li><a href="#tabs-1"><%=vend_Info_L%></a></li>
		    <li><a href="#tabs-2"><%=comm_Info_L%></a></li>
		    <li><a href="#tabs-3"><%=fin_Info_L%></a></li> 
		    <li><a href="#tabs-4"><%=attachments_L%></a></li>
		    <li><a href="#tabs-5"><%=bank_Info_L%></a></li>
		  ...
		  <input type="hidden" name="tabVal1" id="tabVal1" value="" >
		    <table class="table table-bordered">
		    	<Tr>
				<Th align="left"><%=Title_L%> <font color="red">*</font></Th> 
				<Td>
			...
			<Tr>
		    		<Th align="left"><%=vendName_L%><font color="red">*</font></Th> 
		    		<Td>
		    	...
		    	<Tr>
				<Th align="left"><%=srchTerm_L%> <font color="red">*</font></Th>
				<Td>
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<tr>
							    ...
							    <th align="left"><%=Addr_Line2_L%></th>
							    <td>
								<input type="text" class="form-control" name="addrsLine2" value="<%=checkNull(AddressLine2)%>" maxlength="50">
							    </Td>
							    <th align="left"><%=postal_code_L%> <font color="red">*</font></th>
							    <td>
								<input type="number" class="form-control" name="postalCode" value="<%=checkNull(PostalCode)%>" maxlength="50">
							    </Td>
						<th align="left"><%=alt_Phone_no_L%></th>
						<td>
...
%>
							    ...
							    <th align="left"><%=vend_mbl_no_L%><font color="red">*</font></th>
								<td>
								<input type="text" class="form-control validate[required]" name="mobNum" value="<%=checkNull(MobileNumber)%>" maxlength="50">
								<!--<input type="text" class="form-control" name="mobNum" value="<%=checkNull(MobileNumber)%>" maxlength="50">-->
								</Td>
						</tr>
						<tr>
						<th align="left"><%=Addr_Line4_L%></th>
							<td>
							<input type="text" class="form-control" name="addrsLine4" value="<%=checkNull(AddressLine4)%>" maxlength="50">
							    ...
							    <th align="left"><%=vend_city_L%><font color="red">*</font></th>
							    <td>
						...
						<tr>
							   <th align="left"><%=Addr_Line5_L%></th>
								...
								<Select name="state" id="state" class="form-control select2">
									...
									<option value="26">Andaman and Nico</option>
									...
									<!--<option value="A1">India</option>
									<option value="A2">India</option>
									<option value="A3">India</option>
									<option value="A4">India</option>
									<option value="AN">Andhra Pradesh</option>
						...
						<tr>
							   <th align="left"><%=email_addr1_L%> <font color="red">*</font></th>
							    <td>
								<input type="text" class="form-control validate[required,custom[email]]" name="email_1" value="<%=checkNull(EamilAddress1)%>" maxlength="50">
							    </Td>
						<th align="left"><%=email_addr2_L%></th>
						<td>
						<input type="text" class="form-control" name="email_2" value="<%=checkNull(EamilAddress2)%>" maxlength="50">
						</Td>
						<th align="left"><%=website_L%></th>
						<td>
						...
						<Tr>
							<Th colspan="2" align="left"> <%=prfrd_con_mthd_L%><font color="red">*</font></Th>
...
%>	
		...
		<div class="row" id="tabContents">
			...
			<div class="col-md-12">
				<div class="box box-primary">
					<div class="box-header with-border">
						<h2 class="box-title"><%=Contacts_L%></h2> 
					</div>
					<div class="box-body">
						<table id="contactTab" class="table table-bordered">
							<tr>

								    <th align="left"><%=Sr_no_L%></th>
								    <Th align="left"><%=Title_L%><font color="red">*</font></Th> 
								    <th align="left"><%=main_cont_per_L%> <font color="red">*</font></th>
								    <th align="left"><%=designation_L%><font color="red">*</font></th>
								    <th align="left"><%=phone_no_L%> <font color="red">*</font></th>
								    <th align="left"><%=email_L%> <font color="red">*</font></th>
...
%>  
								<tr>
									...
									<td>
										<select name="contactTitle_<%=lineItemNo%>" class="form-control validate[required]">
											<option value="" selected>--select--</option>
											<option value="Mr.">Mr.</option>
											<option value="Ms.">Ms.</option>
											<option value="Mr. and Mrs.">Mr. and Mrs.</option>
									...
									<td>
										<input type="text" class="form-control validate[required]" id="contactEmail_<%=lineItemNo%>" name="contactEmail_<%=lineItemNo%>" value="<%=checkNull(contactMap.get("contactEmail_"+lineItemNo))%>" maxlength="50">
									</td>									    
								</tr>
<%
							}
%>
		  ...
		  <input type="hidden" name="tabVal2" id="tabVal2" value="" >
			...
			<table class="table table-bordered">
				<Tr>
					<Th align="left"><%=entity_Type_L%> <font color="red">*</font></Th>
					<Td colspan="3">
...
%>									
					...
					<Tr>
					<Th align="left"> <%=supplier_Type_L%><font color="red">*</font></Th>
					<Td colspan="3">
						<div>
<%						
...
%>							
				...
				<Tr>
					<Th align="left"><%=vendor_Type_L%> <font color="red">*</font></Th>
					<Td colspan="3">
						<div >
<%						
...
%>								
				...
				<Tr>
					<Th align="left"><%=pur_Order_Currency_L%> <font color="red">*</font> </Th>
					<Td>
...
%>
					...
					<Th align="left"> <%=pmnt_Terms_L%> <font color="red">*</font></Th>
					<Td>
...
%>					
				...
				<Tr>
					<Th align="left"><%=dlvry_Place_L%><font color="red">*</font> </Th>
					<Td>
					...
					<Th align="left"> <%=inco_Terms_L%> <font color="red">*</font></Th>
					<Td>
...
%>					
				...
				<Tr>
					<Th align="left"><%=copy_of_pan_L%> <font color="red">*</font></Th>
					<Td>
					...
					<Th align="left"><%=Pan_name_L%> <font color="red">*</font></Th>
					<Td>
				...
				<Tr>
					<Th align="left"><%=pan_Number_L%> <font color="red">*</font></Th>
					<Td>
						<input type="text" class="form-control"  id="PAN_Number" name="PAN_Number"  value="<%=checkNull(PAN_Number)%>" maxlength="100">
					</Td>
					<!--<Th align="left"> Upload <font color="red">*</font></Th>-->
					<td><button type="button"  id="VENDREGPAN" value="VENDREGPAN"  class="btn btn-primary uploadDialogBtn" ><i class="fa fa-upload"></i>&nbsp;<%=Upload_L%></button></td>
					<td>
...
%>
				...
				<Tr>
					<Th align="left"> <%=GST_firm_L%> <font color="red">*</font></Th>
					<Td>
...
%>
					...
					<Th align="left"> <%=type_of_Reg_L%> <font color="red">*</font></Th>
					<Td>
...
%>
				...
				<Tr>
					<Th align="left"> <%=GSTIN_L%> <font color="red">*</font></Th>
					<Td>
					...
					<td><button type="button" id="VENDREGGST" value ="VENDREGGST"  class="btn btn-primary uploadDialogBtn" ><i class="fa fa-upload"></i>&nbsp;<%=Upload_L%> </button></td>
					<td>
...
%>
				...
				<Tr>
					<Th align="left"><%=CIN_number_L%> <font color="red">*</font></Th>
					<Td>
						<input type="text"  class="form-control"   id="cin_Number" name="cin_Number"  value="<%=checkNull(CIN_Number)%>" maxlength="100" >
					</Td>
					<td><button type="button" id="VENDREGCIN" value ="VENDREGCIN"  class="btn btn-primary uploadDialogBtn" ><i class="fa fa-upload"></i>&nbsp;<%=Upload_L%></button></td>
					<td>
					 <table class="VENDREGCINTABLE table  table-bordered dt-responsive nowrap" id="VENDREGCINTABLE" name="VENDREGCINTABLE" >
<%
	Vector itemIndCin=retUploadDocs.where(new String[]{"EUD_DOC_TYPE"},new String[]{"VENDREGCIN"});
	for(int v1=0;v1<itemIndCin.size();v1++)
	{	
		int index1 = -1;
		try{
		index1 = Integer.parseInt(itemIndCin.get(v1)+"");	}
		catch(Exception e){}				
		if(index1>=0){
...
%>
		  ...
		  <input type="hidden" name="tabVal3" id="tabVal3" value="" >
		   	...
		   	<table class="table table-bordered">
				<Tr>
					<Th align="left"><%=vend_Status_L%> <font color="red">*</font> </Th>
					<Td colspan="3">
						<div class="form-check">
<%
...
%>										
				...
				<Tr id="msmeInfo" style="display:<%=dispMSME%>;">
					<Th align="left"><%=MSME_Reg_Num_L%></Th>
					<Td width="30%">
					...
					<td><button type="button"  id="VENDREGMSME" value="VENDREGMSME"  class="btn btn-primary uploadDialogBtn" ><i class="fa fa-upload"></i>&nbsp;<%=Upload_L%></button></td>
					<td>
...
%>
		...
		<Tr>
			<Th align="left"><%=vend_Buss_Status_L%> <font color="red">*</font> </Th>
			<Td colspan="3">
				<div class="form-check">
<%
...
%>									
							<input type="radio" name="bus_Status"  class="form-check-input validate[required]" data-errormessage-value-missing="Please Select Business Staus of Vendor" value="<%=me.getKey()%>" <%=chksel%>>&nbsp;&nbsp;&nbsp;<%=me.getValue()%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<%
					}				
%>					  
				</div>
				...
				<Tr>
					<Th align="left"><%=E_Invoicing_L%> </Th>
					<Td colspan="3">
						<div class="form-check">
<%
...
%>							
				...
				<Tr>
					<Th align="left"><%=JUBL_entities_L%> </Th>
					<Td colspan="3">
						<div class="form-check">
<%
...
%>						
				...
				<Tr id="vendUnit" style="display:<%=dispUnit%>;">
					...
					<Td colspan="3">
						<input type="text" class="form-control"  name="vend_Unit"  value="<%=checkNull(vend_Unit)%>" maxlength="20" >
					</Td>					
				</Tr>				
				<Tr>
					<Th align="left"><%=vend_Trans_L%></Th>
					<Td colspan="3">
						<div class="form-check">
<%
...
%>					
	...
	<table class="table table-bordered">
			<Tr>
				<Th align="left" width="30%"><%=income_tax_L%> </Th>
				<Td width="20%">
					<input type="text" class="form-control"  name="itrAttach" value="<%=checkNull(itrAttach)%>" maxlength="20" >
				</Td>				
				<td width="20%"><button type="button"  value = "VENDITR"  class="btn btn-primary uploadDialogBtn" ><i class="fa fa-upload"></i>&nbsp;<%=Upload_L%></button></td>
				<td width="30%">
					<table class="VENDITRTABLE table  table-bordered dt-responsive nowrap" id="VENDITRTABLE" name="VENDITRTABLE" >
<%
		Vector itemIndITR=retUploadDocs.where(new String[]{"EUD_DOC_TYPE"},new String[]{"VENDITR"});
		for(int v1=0;v1<itemIndITR.size();v1++)
		{	
			int index1 = -1;
			try{
			index1 = Integer.parseInt(itemIndITR.get(v1)+"");
			}catch(Exception e){}				
			if(index1>=0){
%>
			<tr>
...
%>
		...
		<table class="table table-bordered">
		<Tr>
				<Th align="left" width="30%"><%=MOA_AOA_L%></Th>
				<Td width="20%">
					<input type="text" class="form-control"  name="moaAttach" value="<%=checkNull(moaAttach)%>" maxlength="20" >
				</Td>				
				<td width="20%"><button type="button"  value = "VENDMOA"  class="btn btn-primary uploadDialogBtn" ><i class="fa fa-upload"></i>&nbsp;<%=Upload_L%></button></td>
				<td width="30%">
					<table class="VENDMOATABLE table  table-bordered dt-responsive nowrap" id="VENDMOATABLE" name="VENDMOATABLE" >
<%
		Vector itemIndMOA=retUploadDocs.where(new String[]{"EUD_DOC_TYPE"},new String[]{"VENDMOA"});
		for(int v1=0;v1<itemIndMOA.size();v1++)
		{	
			int index1 = -1;
			try{
			index1 = Integer.parseInt(itemIndMOA.get(v1)+"");	
			}catch(Exception e){}				
			if(index1>=0)
			{
%>	
...
%>
		...
		<table class="table table-bordered">
			<Tr>
				<Th align="left" width="30%"><%=certified_Copy1_L%> </Th>
				<Td width="20%">
					<input type="text" class="form-control"  name="fsAttach" value="<%=checkNull(fsAttach)%>" maxlength="20" >
				</Td>					
				<td width="20%"><button type="button"  value = "VENDFS"  class="btn btn-primary uploadDialogBtn" ><i class="fa fa-upload"></i>&nbsp;<%=Upload_L%></button></td>
				<td width="30%">
...
%>
		...
		<table class="table table-bordered">
			<Tr>
				<Th align="left" width="30%"><%=certified_Copy2_L%> </Th>
				<Td width="20%">
					<input type="text" class="form-control"  name="saAttach" value="<%=checkNull(saAttach)%>" maxlength="20" >
				</Td>					
				<td width="20%"><button type="button"  value = "VENDSA"  class="btn btn-primary uploadDialogBtn" ><i class="fa fa-upload"></i>&nbsp;<%=Upload_L%></button></td>
				<td width="30%">
...
%>
		...
		<table class="table table-bordered">
			<Tr>
				<Th align="left" width="30%"><%=list_of_cust_L%></Th>
				<Td width="20%">
					<input type="text" class="form-control"  name="kcAttach" value="<%=checkNull(kcAttach)%>" maxlength="20" >
				</Td>
				<td width="20%"><button type="button"  value = "VENDCUST"  class="btn btn-primary uploadDialogBtn" ><i class="fa fa-upload"></i>&nbsp;<%=Upload_L%></button></td>
				<td width="30%">
...
%>
		  	<table class="table table-bordered">
				<Tr>
					<Th align="left" width="30%"><%=others_L%></Th>
					<Td width="20%">
						<input type="text" class="form-control"  name="othAttach" value="<%=checkNull(othAttach)%>" maxlength="20" >
					</Td>
					<td width="20%"><button type="button"  value = "VENDOTH"  class="btn btn-primary uploadDialogBtn" ><i class="fa fa-upload"></i>&nbsp;<%=Upload_L%></button></td>
					<td width="30%">
...
<%
	...
	if("4500".equals(compCode))
	{
%>
		  <!--My attchment task-->
		   <table class="table table-bordered">
		   				<Tr>
		   					<Th align="left" width="30%"><%=w9Form_L%> <font color="red">*</font></Th>
		   					<Td width="20%">
		   						<input type="text" class="form-control "  name="w9Attach" id="w9Attach" value="<%=checkNull(w9Attach)%>" maxlength="20" >
		   					</Td>
		   					<td width="20%"><button type="button"  value = "VENDW9"  class="btn btn-primary uploadDialogBtn" ><i class="fa fa-upload"></i>&nbsp;<%=Upload_L%></button></td>
		   					<td width="30%">
...
%>
		   ...
		   <table class="table table-bordered">
		   				<Tr>
		   					<Th align="left" width="30%"><%=w8Form_L%></Th>
		   					<Td width="20%">
		   						<input type="text" class="form-control"  name="w8Attach" id="w8Attach" value="<%=checkNull(w8Attach)%>" maxlength="20" >
		   					</Td>
		   					<td width="20%"><button type="button"  value = "VENDW8"  class="btn btn-primary uploadDialogBtn" ><i class="fa fa-upload"></i>&nbsp;<%=Upload_L%></button></td>
		   					<td width="30%">
...
%>	    	
		  ...
		  <input type="hidden" name="tabVal5" id="tabVal5" value="5" >
		  	...
		  	<table class="table table-bordered">
			<Tr>
					<Th align="left"><%=Acc_Person_L%> <font color="red">*</font></Th>
					<Td>
						<!--<input type="text" class="form-control validate[required]"   name="accnt_Per" value="<%=checkNull(Accnt_Person)%>" maxlength="100">-->
						<input type="text" class="form-control input-sm validate[required]" data-errormessage-value-missing="Please Enter Accounting Person Name"   name="accnt_Per"  value="<%=checkNull(accntPerName)%>" maxlength="100" readonly>
					</Td>
					<Th align="left"><%=vendEmail_L%><font color="red">*</font></Th>
					<Td>
					<input type="text" class="form-control validate[required]"   name="accnt_Email" value="<%=checkNull(Accnt_Email)%>" maxlength="100">  
					</Td>
					
				</Tr>		  	
				<Tr>
					<Th align="left"><%=mobile_L%><font color="red">*</font></Th>
					<Td>
					<input type="text" class="form-control validate[required]"   name="accnt_Mobile" value="<%=checkNull(Accnt_Mobile)%>" maxlength="100">
					</Td>				
					<Th align="left"><%=IFSC_Code_L%> <font color="red">*</font></Th>
					<Td>
<%
					if("Y".equals(showStr) && "VAR".equals(userRole))
					{
%>					
...
%>
						<input type="text" class="form-control validate[required]"   name="rtgs_Code" id="rtgs_Code"  value="<%=checkNull(RTGSCode)%>" maxlength="100">			
<%
					}
%>
					</Td>
				...
				<Tr>
					<Th align="left"><%=account_Num_L%> <font color="red">*</font> </Th>
					<Td>
						<input type="text" class="form-control validate[required]"   name="accnt_Number" value="<%=checkNull(Account_Number)%>" maxlength="100">
					</Td>
					<Th align="left"><%=swift_Code_L%></Th>
					<Td>
						<input type="text" class="form-control "   name="bank_Swift" value="<%=checkNull(BankSwift)%>" maxlength="100">
					</Td>
				</Tr>
				<Tr>
					<Th align="left"><%=cancelled_Cheque_L%> <font color="red">*</font> </Th>
					<Td>
						<input type="text" class="form-control validate[required]"   name="chequeNo" value="<%=checkNull(chequeNo)%>" maxlength="100">
					</Td>					
					<td><button type="button"  id="VENDREGCHEQ" value = "VENDREGCHEQ"  class="btn btn-primary uploadDialogBtn" ><i class="fa fa-upload"></i>&nbsp;<%=Upload_L%></button></td>
					<td>
...
<%
	if("VAR".equals(userRole) || showApprove)
	{
		//isEditable = true;
%>	
		<Tr>
				<Th align="left"><%=wh_Tax_Code_L%></Th>
				<Td>
...
%>
				...
				<Th align="left"><%=wh_Tax_Type_L%> </Th>
					<Td id="WTT">
				...
				<Tr>
					<Th align="left"><%=recon_Acc_Type_L%><font color="red">*</font> </Th>
					<Td>
...
%>
					...
					<Th align="left"><%=recon_Acc_L%><font color="red">*</font> </Th>
					<Td>
...
%>
				...
				<Tr>
					<Th colspan="2" align="left"><%=docs_Verified_L%> <font color="red">*</font></Th>
					<Td colspan="2">
						<div class="form-check">
<%
...
<%
	...
	if("SCH1".equals(userRole))
	{	
		//isEditable = true;
%>
				<Tr>
					<Th align="left"><%=check_List_L%><font color="red">*</font></Th>
					<Td colspan="3">
						<div >
<%						
							set = chkListHM.entrySet();
							i = set.iterator();
							while(i.hasNext()) 
							{	
								Map.Entry me = (Map.Entry)i.next();
								...
								if(vendorTypeVec.contains(cntVal)) chksel="checked"; 
%>						
									<input type="checkbox" id="chkList" class="form-check-input validate[required]"  data-errormessage-value-missing="Please Verify CheckList"  value="<%=me.getKey()%>" <%=chksel%>>&nbsp;&nbsp;&nbsp;<%=me.getValue()%>&nbsp;&nbsp;&nbsp;		
<%
							}
%>								
						</div>
...
%>	
				<Tr <%=trBGColor%>>
					...
					<Th width="20%"><%=user_L%></Th>
					<Th width="20%"><%=date_L%></Th>
					<Th width="60%"><%=comments_L%></Th>
				</Tr>
<%
			}
...
%>
		<Table align="center" width="100%" border=1 borderColorDark=#ffffff borderColorLight=#006666 cellPadding=2 cellSpacing=0 >
			<Tr <%=trBGColor%>>
				<Th align=left ><B><%=enter_Comments%></B></Th>
			</Tr>
			<Tr>	
...
%>			
		...
		<div class="row">
			<div class="col-xs-12" align="center">
				<button type="button" class="btn btn-primary" onclick="javascript:history.go(-1)" style="margin-right: 5px;"><i class="fa fa-backward"></i>&nbsp;<%=back_L%></button>			
<%
	if(vendSubmit)
	{
%>
				<button type="button" class="btn btn-primary" onclick="funSubmit('V')" style="margin-right: 5px;"><i class="fa fa-submit"></i>&nbsp;<%=submit_L%></button>
<%
	}
	if(vendReSubmit)
	{
%>	
				<button type="button" class="btn btn-primary" onclick="funSubmit('U')" style="margin-right: 5px;"><i class="fa fa-submit"></i>&nbsp;<%=re_Submit_L%></button>	
<%				
	}
	if(showSubmit)
	{
%>
				<button type="button"  value="H" class="btn btn-info uploadDialogBtnTemp" ><i class="fa fa-upload"></i>&nbsp;<%=upl_Attchmnt_L%></button>		
				<button type="button" class="btn btn-success" onclick="funSubmit('S')" style="margin-right: 5px;"><i class="fa fa-submit"></i>&nbsp;<%=submit_L%></button>
<%
	}
	if(showApprove)
	{
%>
				<button type="button" id="postSAP" class="btn btn-success" onclick="funSubmit('P')" style="margin-right: 5px;"><i class="fa fa-submit"></i>&nbsp;<%=approve_L%></button>
<%
	}
	if(showReject && !"PP".equals(userRole))	
	{
%>
				<button type="button"  class="btn btn-danger" onclick="funSubmit('R')" style="margin-right: 5px;"><i class="fa fa-submit"></i>&nbsp;<%=reject_L%></button>
...
<%
	...
	if("2".equals(userType))
	{
		if("PP".equals(userRole) && !"APPROVED".equals(wfStatus))
		{
%>
				
				<button type="button"  class="btn btn-danger" onclick="funSubmit('B')" style="margin-right: 5px;"><i class="fa fa-submit"></i>&nbsp;<%=send_Back_L%></button>
<%
		}
...
%>	
				<button type="button" class="btn btn-warning" onclick="funQuery('<%=docId%>','VNR','<%=compCode%>','<%=venWFPlant%>','<%=venWFCategory%>','0')" style="margin-right: 5px;"><i class="fa fa-question-circle"></i> <%=query_L%></button>
<%
		}
%>				
				<button type="button" class="btn btn-primary" onclick="funShowApprovalHirearchy('<%=compCode%>','<%=venWFPlant%>','<%=venWFCategory%>','0')" style="margin-right: 5px;"><i class="fa fa-users"></i><%=show_App_Hirearchy_L%></button>
				<button type="button" class="btn btn-primary" onclick="funAuditTrail('<%=docId%>','VNR')" style="margin-right: 5px;"><i class="fa fa-list"></i> <%=audit_Trail_L%></button>			
<%
	}
%>					
...
<%
	...
	if("VAR".equals(userRole) && showSubmit)
	{
%>
...
<%
	...
	if("SCH".equals(userRole) && showSubmit)
	{	
%>		
			$('#chkList').prop('disabled',false);
<%
	}
%>			
...
%>
	...
	function isValidComInfo()
	{
		...
		*/
		...
		/*else if( w9Name!="" && w9TabLen != 0)
		{
			$('#VENDW9TABLE').validationEngine('showPrompt', 'Please upload W9 Form document', '')
			//document.myForm.PAN_Number.value = "";
			return false;
		}
	...
	{
		var msmeType = document.myForm.msme_Type.value;
		var msmeNo = document.myForm.msme_Udyog_AdhrNo.value;
		var msmeTabLen = $('#VENDREGMSMETABLE tr').length;
		...
		if(msmeType != "0" && msmeNo == "")
		{
			$('#msme_Udyog_AdhrNo').validationEngine('showPrompt', 'Please Enter MSME Number', '')
			return false;
		}
		else if(msmeType != "0" && msmeNo!="" && msmeTabLen == 0) 
		{
			$('#VENDREGMSME').validationEngine('showPrompt', 'Please upload MSME document', '')
			return false;
		}		
		else
		{
	...
	function isValidAttachment()
	{
		...
		if(vendType == "IN")
		{
			/*if(w9Attach == "")
			{
				$('#w9Attach').validationEngine('showPrompt', 'Please Enter W9 Form', '')
				return false;
			}*/		
			 //if(w9Attach!="" && w9TabLen == 0 )
			if(w9TabLen == 0 )
			{
				//alert("enter If");
				$('#VENDW9TABLE').validationEngine('showPrompt', 'Please upload W9 Form', '');
				return false;
			}		
			else 
			{
		...
		if(vendType == "IM")
		{
			if(w8Attach == "")
			{
				$('#w8Attach').validationEngine('showPrompt', 'Please Enter W8 Form', '')
				return false;
			}		
			 if(w8Attach!="" && w8TabLen == 0 )
			{
				//alert("enter If");
				$('#VENDW8TABLE').validationEngine('showPrompt', 'Please upload W9 Form', '');
				return false;
			}		
			else 
			{
	...
	{
		var chequeNo = document.myForm.chequeNo.value;
		var bankTabLen = $('#VENDREGCHEQTABLE tr').length;
		
		//var whTaxType = document.myForm.whTaxType.value;
		//var whTaxCode = document.myForm.whTaxCode.value;
		
		if(chequeNo !="" && bankTabLen == 0) 
		{
			$('#VENDREGCHEQ').validationEngine('showPrompt', 'Please upload Cancelled Cheque', '')
			return false;
		}
		/*if(whTaxType !="" && whTaxCode == "") 
		{
			$('#whTaxCode').validationEngine('showPrompt', 'Please Select withhold TaxCode', '')
			return false;
		}*/		
		else
		{
