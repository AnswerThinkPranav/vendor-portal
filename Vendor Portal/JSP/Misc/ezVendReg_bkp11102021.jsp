...
%>
											<input type="checkbox"  name="conMethod" value="<%=me1.getKey()%>" <%=chksel%> >&nbsp;&nbsp;&nbsp;<%=me1.getValue()%>&nbsp;&nbsp;&nbsp;&nbsp;	
<%
									}
%>	
...
%>  
								<tr>
									...
									<td>
										<select class="form-control" name="contactTitle_<%=lineItemNo%>">
											<option value="" selected>--select--</option>
											<option value="Mr.">Mr.</option>
											<option value="Ms.">Ms.</option>
											<option value="Mr. and Mrs.">Mr. and Mrs.</option>
...
%>
												<input type="radio" name="typeOfOrg"  class="form-check-input"  value="<%=me2.getKey()%>" <%=chksel%>>&nbsp;<%=me2.getValue()%>&nbsp;
<%
										}
									}
%>									
								...
								<div class="form-check">
									...
									<input type="text" name="othCompType" value="<%=othCompType%>" maxlength="50" style="width:30%;"></input>
								</div>	
					</td>
...
%>
										<input type="checkbox"  name="supType" value="<%=me.getKey()%>" <%=chksel%> >&nbsp;&nbsp;&nbsp;<%=me.getValue()%>&nbsp;&nbsp;&nbsp;	
<%
								}
							}
%>							
...
%>						
									<input type="checkbox" name="vendorType" value="<%=me.getKey()%>" <%=chksel%>>&nbsp;&nbsp;&nbsp;<%=me.getValue()%>&nbsp;&nbsp;&nbsp;		
<%
							}
%>								
						</div>
...
%>				
										<option value="<%=pmntObj.getFieldValueString(j,"EMKV_KEY").trim()%>" <%=chksel%>><%=pmntObj.getFieldValueString(j,"EMKV_VALUE")%></option>
<%				
									}
%>					
								</select>
				...
				<Tr>
					...
					<Td>
						<input type="text" class="form-control"  id="INCO_Terms2" name="INCO_Terms2"  value="<%=INCO_Terms2%>" maxlength="100">
					</Td>				
...
%>				
										<option value="<%=incoObj.getFieldValueString(j,"EMKV_KEY").trim()%>" <%=chksel%>><%=incoObj.getFieldValueString(j,"EMKV_VALUE")%></option>
<%				
									}
%>					
						</select>
				...
				<Tr>
					<Th align="left"> Legal Name as per PAN</Th>
					<Td>
					...
					<Td>
						<select class="form-control select2" name="PAN_Attach">
							<option value="" selected>--select--</option>
...
%>
				...
				<Tr>
					<Th align="left"> Status of Firm <font color="red">*</font></Th>
					<Td>
...
%>									
										<input type="radio" name="msme_Type"  value="<%=me.getKey()%>" <%=chksel%>>&nbsp;&nbsp;&nbsp;<%=me.getValue()%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<%
								}
%>										
						</div>
...
%>									
							<input type="radio" name="bus_Status"  value="<%=me.getKey()%>" <%=chksel%>>&nbsp;&nbsp;&nbsp;<%=me.getValue()%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<%
					}				
%>					  
...
<%
							...
							if("Y".equals(vend_Jgl)) 
								...
								chkSupNo="checked";
%>						
							<input class="form-check-input" type="radio"   name="vend_Jgl" value="Y" <%=chkSupYes%>>&nbsp;&nbsp;&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input class="form-check-input" type="radio"   name="vend_Jgl" value="N" <%=chkSupNo%>>&nbsp;&nbsp;&nbsp;No&nbsp;
						</div>
					</Td>
				</Tr>
				<Tr>
...
%>					
						<div class="form-check">
							<input class="form-check-input" type="radio"   name="vend_Site" value="Y" <%=chkSiteYes%>>&nbsp;&nbsp;&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input class="form-check-input" type="radio"   name="vend_Site" value="N" <%=chkSiteNo%>>&nbsp;&nbsp;&nbsp;No&nbsp;
						</div>
					</Td>
				</Tr>				
</table>
		  ...
		  <input type="hidden" name="tabVal4" id="tabVal4" value="" >
		  	...
		  	<table class="table table-bordered">
				<Tr>
					...
					<td><button type="button"  value = "VENDFS"  class="btn btn-primary uploadDialogBtn" ><i class="fa fa-upload"></i>&nbsp;Upload</button></td>
					<td>
...
%>
		  	...
		  	<table class="table table-bordered">
				<Tr>
					...
					<td><button type="button"  value = "VENDSA"  class="btn btn-primary uploadDialogBtn" ><i class="fa fa-upload"></i>&nbsp;Upload</button></td>
					<td>
...
%>
		  	...
		  	<table class="table table-bordered">
				<Tr>
					...
					<td><button type="button"  value = "VENDCUST"  class="btn btn-primary uploadDialogBtn" ><i class="fa fa-upload"></i>&nbsp;Upload</button></td>
					<td>
...
%>
		  	...
		  	<table class="table table-bordered">
				<Tr>
					...
					<td><button type="button"  value = "VENDSOP"  class="btn btn-primary uploadDialogBtn" ><i class="fa fa-upload"></i>&nbsp;Upload</button></td>
					<td>
...
%>
		  	...
		  	<table class="table table-bordered">
				<Tr>
					...
					<td><button type="button"  value = "VENDOTH"  class="btn btn-primary uploadDialogBtn" ><i class="fa fa-upload"></i>&nbsp;Upload</button></td>
					<td>
		  ...
		  <input type="hidden" name="tabVal5" id="tabVal5" value="5" >
			...
			<Tr>
				...
				<Tr>
					...
					<Td>
						<input type="text" class="form-control validate[required]"   name="bank_Swift" value="<%=checkNull(BankSwift)%>" maxlength="100">
					</Td>
				</Tr>
				<Tr>
...
%>
	...
	setSelectBoxVal('contactTitle_2','<%=checkNull(contactMap.get("contactTitle_2"))%>',disableFlag);
	setSelectBoxVal('state','<%=State%>',disableFlag);
