...
<%
	...
	qryGetCompCode = "SELECT ECFH_VEN_TYPE,ECFH_DOC_ID,ECFH_EXT1 FROM EZC_CUST_FORM_HEADER";
	ezc.ezcommon.EzLog4j.log("** qryGetCompCode"+qryGetCompCode,"I");

	miscTableRow3.setQuery(qryGetCompCode);
	...
	for(int i=0; i<qcsRetqcsRetCompCodeCnt; i++)
	{
		hashCompCode.put(qcsRetCompCode.getFieldValueString(i,"ECFH_DOC_ID"),qcsRetCompCode.getFieldValueString(i,"ECFH_EXT1"));	
	}
