...
<%
	...
	if(!"QCF_COMMENTS".equals(rqstMenu))
		...
		checkStatus += ") AND EWDHH_CURRENT_STEP <= (SELECT EWTS_STEP FROM EZC_WF_TEMPLATE_STEPS WHERE EWTS_CODE='"+template+"' AND EWTS_STEP_DESC in ('GM','SGM')";
	...
	if(auditType != null && !"-".equals(auditType))
	{
		...
		System.out.println("CHECKNOOOOOO");	
