...
ezc.ezcommon.EzLog4j.log(":::::::::::toDate::::::::::"+ToDat,"I"); 
	...
	ezc.ezparam.ReturnObjFromRetrieve retRejMatDocsObj=new ezc.ezparam.ReturnObjFromRetrieve(new String[]{"MATDOCNO","PONUM","POITEMNO","MATCODE","MATDESC","UOM","QTY","INSLOT","UD_TYPE","REF_DOC"});
	...
	try
	{
		...
		parameterList.setValue("105","MOVEMENT_TYPE");
		try
 		{
