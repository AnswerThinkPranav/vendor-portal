...
<%
	...
	if(!userType.equals("3"))
	{
		...
		ezc.ezcommon.EzLog4j.log(">>>>>>>>>>>>>>>>>>>>>>>Inside BANNER SOLD TO Desiredstep is 	:"+callPreWelcomePage,"I");
		...
		if("Y".equals(callPreWelcomePage) || "S".equals(callPreWelcomePage))
		{
			...
			ezc.ezcommon.EzLog4j.log(">>Inside BANNER SOLD TO getWorkFlowUsers callPreWelcomePage retsoldto 	:"+retsoldto.toEzcString(),"I");
		}	
	}
	else
	{
		if("Y".equals(callPreWelcomePage) || "S".equals(callPreWelcomePage))
		{
			...
			ezc.ezcommon.EzLog4j.log(">>Inside BANNER SOLD TO getUserVendors retsoldto 	:"+retsoldto.toEzcString(),"I");
		}	
	}
	...
	if("Y".equals(callPreWelcomePage) || "S".equals(callPreWelcomePage))
	{
		...
		//out.println("::After changing syskey::"+session.getValue("SYSKEY"));
		...
		for(int i=0;i<soldtoRows;i++)
		{
			...
			if(i==0)
				...
				soldToInStr+="','"+tempSoldto;
			vendorsHT.put(retsoldto.getFieldValueString(i,"EC_ERP_CUST_NO").trim(),retsoldto.getFieldValue(i,"ECA_NAME"));
		}	
