...
<%
	...
	try
	{
		...
		filePath = "D:\\usr\\sap\\VMP\\J00\\j2ee\\cluster\\apps\\answerthink.com\\EzCFL\\servlet_jsp\\CFL\\root\\EzCommerce\\EzCFL\\Vendor2\\JSPs\\Misc";
	...
	if(count>0)
	{
		...
		{
			plantAddrHT.put(ret.getFieldValueString(i,"CODE"),ret.getFieldValueString(i,"NAME"));
		}
	}
	
	//out.println(":::plantAddrHT::::"+plantAddrHT);
%>
